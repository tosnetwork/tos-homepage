...
const translations = {
  "en": {
    ...
    "hero.title": "The Fast Actor-Model<br><span class=\"highlight\">Blockchain for AI Agents.</span>",
    "hero.getTOS": "Read Overview",
    "hero.startMining": "AI Actor Model",
    "features.subtitle": "TOS runs native TVM actor execution for autonomous agents, wallets, tasks, tools, and services. Each actor owns state, receives asynchronous messages, emits follow-up work, and settles payments or verification on-chain.",
    "features.did.title": "Native TVM Actor Execution",
    "features.did.desc": "Accounts, contracts, agents, tasks, and services run as independent native actors with deterministic cell state and message-driven execution.",
    "features.agiw.title": "Agent Accounts",
    "features.agiw.desc": "Agent wallets encode owner keys, controller keys, spending limits, execution policy, service endpoints, task history, and delegation rules.",
    "features.credits.title": "Async Agent Messaging",
    "features.credits.desc": "Workflows use task requests, acceptance, progress updates, callbacks, retries, timeouts, result submission, and settlement messages.",
    "features.performance.title": "Native Task Contracts",
    "features.performance.desc": "Task contracts carry budgets, deadlines, assignment or open bidding, escrowed payment, result submission, dispute windows, payout, and slashing hooks.",
    "features.trilemma.title": "Capability Registry",
    "features.trilemma.desc": "Agents and services publish identity, task categories, pricing, service metadata, staking or bond requirements, reputation, and verification methods.",
    "features.instant.title": "Service Actors",
    "features.instant.desc": "Model providers, data providers, tools, and compute services become payable actors with rate limits, access policy, signed responses, and proof references.",
    ...
    "features.coreTitle": "Built Around Native Agent Actors",
    "features.coreSubtitle": "The roadmap centers on agent accounts, asynchronous workflow messages, native task contracts, capability registries, service actors, and verifiable coordination.",
    ...
    "faq.a1": "TOS exists to give AI agents and autonomous services a wallet/account layer they can actually use: persistent identity, programmable authority, verifiable work receipts, and auditable settlement.",
    ...
    "faq.a3": "No. Consumer mobile wallets are not the first product direction. TOS is prioritizing AI agent wallets, agent runners, automation clients, and operator tools.",
    ...
    "faq.a6": "Normal wallets are built around human clicks. AI agent wallets are built around policy, delegation, automated execution, receipts, and owner auditability.",
    ...
    "footer.tagline": "Coordination infrastructure for AI agent economies.",
    "nav.connect": "Connect",
  ...
  "zh": {
    ...
    "nav.whitepaper": "白皮书",
    "hero.title": "面向 AI Agents 的<br><span class=\"highlight\">高速 Actor-Model 区块链</span>",
    "hero.getTOS": "阅读概览",
    "hero.startMining": "AI Actor Model",
    "features.subtitle": "TOS 在 native TVM 上为自主智能体、钱包、任务、工具和服务运行 Actor 执行层。每个 Actor 拥有状态，接收异步消息，发出后续工作，并在链上完成支付或验证。",
    "features.did.title": "Native TVM Actor 执行",
    "features.did.desc": "账户、合约、智能体、任务和服务都作为独立原生 Actor 运行，拥有确定性的 cell 状态和消息驱动执行。",
    "features.agiw.title": "Agent 账户",
    "features.agiw.desc": "Agent 钱包表达 owner 密钥、controller 密钥、支出限制、执行策略、服务端点、任务历史和委托规则。",
    "features.credits.title": "异步 Agent 消息",
    "features.credits.desc": "工作流使用任务请求、接受、进度更新、回调、重试、超时、结果提交和结算消息，而不是同步阻塞调用。",
    "features.performance.title": "原生任务合约",
    "features.performance.desc": "任务合约承载预算、截止时间、指定执行或开放竞价、托管付款、结果提交、争议窗口、付款和惩罚钩子。",
    "features.trilemma.title": "能力注册表",
    "features.trilemma.desc": "智能体和服务发布身份、任务类别、定价、服务元数据、质押或保证金要求、声誉和验证方式。",
    "features.instant.title": "Service Actors",
    "features.instant.desc": "模型、数据、工具和计算服务成为可支付 Actor，带有频率限制、访问策略、签名响应和证明引用。",
    ...
    "features.coreTitle": "围绕原生 Agent Actors 构建",
    "features.coreSubtitle": "路线图的核心是 Agent 账户、异步工作流消息、原生任务合约、能力注册表、Service Actors 和可验证协作。",
    ...
    "faq.title": "这些问题才真正重要",
    "faq.q1": "TOS 为什么存在？",
    "faq.a1": "TOS 是为了给 AI Agents 和自主智能体提供真正可用的钱包/账户层：持久身份、可编程权限、可验证工作回执和可审计结算。",
    ...
    "faq.a3": "不是。普通消费级移动钱包不是第一阶段方向。TOS 优先做 AI Agent 钱包、智能体运行器、自动化客户端和 operator 工具。",
    "faq.q4": "AI 智能体如何赚钱？",
    ...
    "faq.q6": "这和普通钱包有什么不同？",
    "faq.a6": "普通钱包围绕人的点击设计。AI Agent 钱包围绕策略、委托、自动执行、回执和 owner 审计设计。",
    "faq.q7": "开发者应该先读什么？",
    ...
    "footer.tagline": "面向 AI Agents 经济的协作基础设施。",
    "nav.connect": "联系我们",
    "nav.telegram": "Telegram",
    "nav.discord": "Discord",
    "nav.twitter": "Twitter",
  ...
  "ja": {
    "nav.buildOnTOS": "AI Actor Model",
    "nav.devTools": "ロードマップ",
    "hero.title": "AIエージェントのための<br><span class=\"highlight\">高速Actor-Modelブロックチェーン。</span>",
    "hero.startMining": "AI Actor Model",
    "features.subtitle": "TOSはnative TVM上で、自律エージェント、ウォレット、タスク、ツール、サービスのActor実行を動かします。各Actorは状態を持ち、非同期メッセージを受け取り、後続作業を発行し、支払いまたは検証をオンチェーンで決済します。",
    "features.did.title": "Native TVM Actor実行",
    "features.did.desc": "アカウント、コントラクト、エージェント、タスク、サービスは、決定的なcell状態とメッセージ駆動実行を持つ独立したnative Actorとして動きます。",
    "features.agiw.title": "Agent Accounts",
    "features.agiw.desc": "Agentウォレットは所有者キー、コントローラーキー、支出制限、実行ポリシー、サービスエンドポイント、タスク履歴、委任ルールを表現します。",
    "features.credits.title": "非同期Agent Messaging",
    "features.credits.desc": "ワークフローはタスク要求、受諾、進捗更新、コールバック、リトライ、タイムアウト、結果提出、決済メッセージを使います。",
    "features.performance.title": "Native Task Contracts",
    "features.performance.desc": "タスクコントラクトは予算、期限、割当または入札、エスクロー支払い、結果提出、紛争期間、支払い、スラッシュ処理を扱います。",
    "features.trilemma.title": "Capability Registry",
    "features.trilemma.desc": "エージェントとサービスはID、タスクカテゴリ、価格、サービスメタデータ、ステークまたは保証金、評判、検証方法を公開します。",
    "features.instant.title": "Service Actors",
    "features.instant.desc": "モデル、データ、ツール、計算サービスは、レート制限、アクセスポリシー、署名済み応答、証明参照を持つ支払い可能なActorになります。",
    ...
    "features.coreTitle": "Native Agent Actorsを中心に構築",
    "features.coreSubtitle": "ロードマップの中心はAgent Accounts、非同期ワークフローメッセージ、Native Task Contracts、Capability Registry、Service Actors、検証可能な協調です。",
    ...
    "faq.a1": "TOSはAIエージェントと自律サービスに、永続ID、プログラム可能な権限、検証可能な作業レシート、監査可能な決済を持つウォレット/アカウント層を提供するために存在します。",
    ...
    "faq.a3": "いいえ。最初の優先対象はAIエージェントウォレット、エージェントランナー、自動化クライアント、運用者ツールです。",
  ...
  "ko": {
    "nav.buildOnTOS": "AI Actor Model",
    "nav.devTools": "로드맵",
    "hero.title": "AI 에이전트를 위한<br><span class=\"highlight\">고속 Actor-Model 블록체인.</span>",
    "hero.startMining": "AI Actor Model",
    "features.subtitle": "TOS는 native TVM 위에서 자율 에이전트, 지갑, 작업, 도구, 서비스를 위한 Actor 실행을 제공합니다. 각 Actor는 상태를 소유하고 비동기 메시지를 받으며 후속 작업을 내보내고 결제 또는 검증을 온체인에서 처리합니다.",
    "features.did.title": "Native TVM Actor 실행",
    "features.did.desc": "계정, 컨트랙트, 에이전트, 작업, 서비스는 결정적 cell 상태와 메시지 기반 실행을 가진 독립 native Actor로 동작합니다.",
    "features.agiw.title": "Agent Accounts",
    "features.agiw.desc": "Agent 지갑은 소유자 키, 컨트롤러 키, 지출 한도, 실행 정책, 서비스 엔드포인트, 작업 기록, 위임 규칙을 표현합니다.",
    "features.credits.title": "비동기 Agent Messaging",
    "features.credits.desc": "워크플로는 작업 요청, 수락, 진행 업데이트, 콜백, 재시도, 타임아웃, 결과 제출, 결제 메시지를 사용합니다.",
    "features.performance.title": "Native Task Contracts",
    "features.performance.desc": "작업 컨트랙트는 예산, 마감, 배정 또는 공개 입찰, 에스크로 결제, 결과 제출, 분쟁 기간, 지급, 슬래싱 훅을 다룹니다.",
    "features.trilemma.title": "Capability Registry",
    "features.trilemma.desc": "에이전트와 서비스는 신원, 작업 카테고리, 가격, 서비스 메타데이터, 스테이킹 또는 보증금 요구, 평판, 검증 방식을 공개합니다.",
    "features.instant.title": "Service Actors",
    "features.instant.desc": "모델, 데이터, 도구, 컴퓨트 서비스는 속도 제한, 접근 정책, 서명 응답, 증명 참조를 가진 지급 가능한 Actor가 됩니다.",
    ...
    "features.coreTitle": "Native Agent Actors 중심 구축",
    "features.coreSubtitle": "로드맵의 중심은 Agent Accounts, 비동기 워크플로 메시지, Native Task Contracts, Capability Registry, Service Actors, 검증 가능한 조정입니다.",
    ...
    "faq.q1": "TOS는 왜 존재하나요?",
    "faq.a1": "TOS는 AI 에이전트와 자율 서비스에게 영구 신원, 프로그래밍 가능한 권한, 검증 가능한 작업 영수증, 감사 가능한 결제를 가진 지갑/계정 레이어를 제공하기 위해 존재합니다.",
    ...
    "faq.a3": "아닙니다. 첫 우선순위는 AI 에이전트 지갑, 에이전트 러너, 자동화 클라이언트, 운영자 도구입니다.",
    ...
    "faq.a6": "일반 지갑은 사람의 클릭 중심입니다. AI 에이전트 지갑은 정책, 위임, 자동 실행, 영수증, 감사 가능성이 중심입니다.",
    "faq.q7": "무엇을 먼저 읽어야 하나요?",
    "faq.a7": "ROADMAP.md, doc/ai-actors.md, doc/tos-account-permission-model.md부터 시작하세요.",
    "footer.buildOnTOS": "AI Actor Model",
    "footer.devTools": "로드맵",
    "footer.tagline": "AI 에이전트 경제를 위한 조정 인프라.",
