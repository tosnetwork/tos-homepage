...
const homepageOverrides = {
  en: {
    ...
    'nav.whitepaper': 'Whitepaper',
    'hero.title': 'Build at Market Speed.<br><span class="highlight">Move Value in Private.</span>',
    'hero.getTOS': 'Read Overview',
    'hero.startMining': 'EVM Workchain',
    'features.subtitle': 'Write async native contracts for million-TPS scale. Write synchronous EVM contracts for financial logic that needs familiar execution. Both rails draw from decade-scale production designs. Uno is a post-quantum privacy chain built 100% from scratch for value that must never hit the public tape.',
    'features.did.title': 'Launch at Machine Speed',
    'features.did.desc': 'For apps that need to fan out fast, stay responsive under load, and avoid the bottlenecks that slow single-lane chains down.',
    'features.agiw.title': 'Reach Ethereum Without Starting Over',
    'features.agiw.desc': 'Bring your Solidity stack, wallets, and user habits with you. TOS lets you enter the Ethereum market without rebuilding from scratch.',
    'features.credits.title': 'Privacy for Serious Value',
    'features.credits.desc': 'When the amount, counterparties, or timing should stay discreet, Uno gives you a rail designed for privacy from day one.',
    'features.performance.title': 'One Network, Not a Patchwork',
    'features.performance.desc': 'Run one core stack instead of stitching together separate chains, sidecars, and competing sources of truth.',
    'features.trilemma.title': 'Operate Without Friction',
    'features.trilemma.desc': 'One control surface for node ops, wallet flows, and workchain tooling means less overhead, fewer mistakes, and faster execution.',
    'features.instant.title': 'One Front Door for Builders',
    'features.instant.desc': 'Give developers familiar interfaces instead of custom glue. TOS exposes the rails they need through one builder-facing surface.',
    'features.pruning.title': 'One State Base, Less Complexity',
    'features.pruning.desc': 'Different execution models can grow without turning the network into a pile of disconnected systems underneath.',
    'features.spv.title': 'Built to Behave Under Pressure',
    'features.spv.desc': 'In real markets, reliability matters. TOS is engineered to reduce the nondeterminism that becomes expensive later.',
    'features.fairlaunch.title': 'Three Markets, One Root of Trust',
    'features.fairlaunch.desc': 'Apps, capital, and privacy can live on different rails without fragmenting the consensus story underneath.',
    'features.deflationary.title': 'Value Moves Where Opportunity Is',
    'features.deflationary.desc': 'Native and EVM flows can meet where it creates upside, while privacy-sensitive value stays isolated on purpose.',
    'features.takovm.title': 'Consensus That Keeps Moving',
    'features.takovm.desc': 'A chain only matters if it keeps producing blocks cleanly. Catchain is the discipline behind that continuity.',
    'features.community.title': 'Bring the Tools You Already Trust',
    'features.community.desc': 'Developers do not want a science project. MetaMask, ethers, Foundry, Hardhat, and Remix already fit the path to market here.',
    'features.zkprivacy.title': 'Privacy That Ages Better',
    'features.zkprivacy.desc': 'Good privacy should not come with a future rewrite bill. Uno starts with a post-quantum posture instead of postponing the problem.',
    'features.cryptography.title': 'Modern Crypto, Lower Migration Risk',
    'features.cryptography.desc': 'The goal is not jargon. It is reducing the chance that future security shifts force current users through painful migration.',
    'features.parallel.title': 'Real Infrastructure, Not a Demo',
    'features.parallel.desc': 'Validator, liteserver, and operator tooling are already in the stack, which is what serious networks need before they can scale trust.',
    'features.security.title': 'Proof, Not Promises',
    'features.security.desc': 'Smart builders and serious capital both look for evidence. The code, docs, papers, and changelogs are there to inspect.',
    'features.encrypted.title': 'Own the Network Layer',
    'features.encrypted.desc': 'When more of the network path is yours, you control more of the performance, resilience, and product experience.',
    'features.communication.title': 'More Than a Chain',
    'features.communication.desc': 'Wallet connection, naming, and decentralized serving make TOS feel like a platform people can build on, not just a ledger they settle to.',
    'features.coreTitle': 'Built for Real Demand',
    'features.coreSubtitle': 'Different users want different outcomes. Builders want speed, capital wants reach, and serious money wants privacy. TOS gives each one the right environment instead of forcing every use case into the same compromise.',
    'performance.title': 'Built for Builders. Clear to Capital.',
    'performance.subtitle': 'These are not vanity metrics. They show how TOS is set up to move faster, reach wider, and protect more.',
    'stats.workchains.label': 'Rails',
    'stats.workchains.desc': 'Native apps, Ethereum reach, Uno privacy',
    'stats.node.label': 'Core Stack',
    'stats.node.desc': 'One network beneath every rail',
    'stats.cli.label': 'Operator Path',
    'stats.cli.desc': 'Less drag from node to wallet tooling',
    'stats.cadence.label': 'Market Rhythm',
    'stats.cadence.desc': 'Built for systems that cannot wait minutes',
    'stats.rpc.label': 'Ethereum Fit',
    'stats.rpc.desc': 'Wallets and tooling already know the path',
    'stats.bridges.label': 'Privacy Bridges',
    'stats.bridges.desc': 'Uno stays sealed by design',
    'stats.state.label': 'Shared Base',
    'stats.state.desc': 'Different rails, one state foundation',
    'stats.network.label': 'Network Depth',
    'stats.network.desc': 'More of the stack is owned in-house',
    'docs.title': 'Start Where Conviction Starts',
    'docs.desc': 'Anyone can market a chain. These are the fastest documents for understanding what TOS can actually ship.',
    'docs.smartContracts': 'See the Big Picture',
    'docs.aiMining': 'See the Market Rail',
    'docs.exploreAll': 'See the Privacy Rail',
    ...
    'faq.a1': 'Because one execution model rarely serves builders, markets, and private value equally well. TOS gives fast apps, Ethereum access, and real privacy separate rails inside one network.',
    'faq.q2': 'What do you actually get from that design?',
    'faq.a2.h1': 'A faster rail for product builders',
    'faq.a2.p1': 'Launch apps on a native layer built for throughput and fan-out when minutes and bottlenecks kill momentum.',
    'faq.a2.h2': 'A direct line into Ethereum users and liquidity',
    'faq.a2.p2': 'Use an EVM rail that keeps familiar wallets and tooling in play instead of asking the market to relearn everything.',
    'faq.a2.h3': 'A private rail when exposure is expensive',
    'faq.a2.p3': 'Move sensitive value on Uno when size, counterparties, or timing should not leak into the open.',
    'faq.a2.h4': 'Less operational drag',
    'faq.a2.p4': 'One validator-engine and one tosctl path keep the stack simpler to run than a stitched-together multi-chain setup.',
    'faq.a2.h5': 'One trust base underneath it all',
    'faq.a2.p5': 'Different rails serve different jobs, but they still share one consensus story and one state foundation.',
    'faq.q3': 'How hard is it for Ethereum teams to move in?',
    'faq.a3': 'Much easier than starting from zero. Existing Solidity teams can bring contracts, wallets, and habits that already match how the market works.',
    'faq.q4': 'Why keep Uno isolated from bridges?',
    'faq.a4': 'Because privacy starts breaking the moment money has to cross public entry and exit points. Uno stays private by refusing that compromise.',
    'faq.q5': 'Is this just positioning, or is there real infrastructure?',
    'faq.a5': 'The repository already ships the node stack, operator CLI, liteserver path, build docs, whitepaper, and technical references. This is being built as infrastructure, not just as a narrative.',
    'faq.q6': 'What makes TOS feel like a platform, not just a ledger?',
    'faq.a6': 'Connect, DNS, Sites, and the networking stack give builders more than settlement. They provide pieces people can actually build products around.',
    'faq.q7': 'Why not force everything into one VM?',
    'faq.a7': 'Because speed, compatibility, and privacy each break in different ways when forced into the same mold. Separate rails let TOS optimize for what actually matters without splitting trust.',
    'faq.bottomText': 'If you want to verify the story, the repo is where the receipts live.',
  ...
  zh: {
    ...
    'nav.whitepaper': '白皮书',
    'hero.title': '面向开放市场构建。<br><span class="highlight">关键价值，保留隐私。</span>',
    'hero.getTOS': '阅读概览',
    'hero.startMining': 'EVM 工作链',
    'features.subtitle': '原生层天生适合异步分片，既要速度，也要扩展。EVM 保持同步体验，让以太坊应用上手就熟。Uno 则承接那些不该暴露的价值。',
    'features.did.title': '快速启动，不被性能拖住',
    'features.did.desc': '面向需要高速扇出、重负载下仍保持响应的应用，避免单通道链常见的性能瓶颈。',
    'features.agiw.title': '无需重来，也能进入以太坊市场',
    'features.agiw.desc': '把 Solidity、钱包和用户习惯一起带过来。TOS 让你进入以太坊市场，而不是重造一遍。',
    'features.credits.title': '为重要价值而生的隐私',
    'features.credits.desc': '当金额、对手方或时机不该被所有人看见时，Uno 提供从第一天就为隐私而建的通道。',
    'features.performance.title': '一张网，不是一堆拼接件',
    'features.performance.desc': '用一套核心栈替代多条链、多个 sidecar 和多套真相源拼起来的复杂系统。',
    'features.trilemma.title': '运维不该成为摩擦',
    'features.trilemma.desc': '一套控制面统一节点、钱包和工作链工具，意味着更低开销、更少误操作、更快执行。',
    'features.instant.title': '开发者只需要一个入口',
    'features.instant.desc': '不要让开发者自己拼胶水层。TOS 用一个统一入口暴露他们真正需要的能力。',
    'features.pruning.title': '一套状态底座，更少复杂度',
    'features.pruning.desc': '不同执行环境可以各自增长，而不把底层网络变成一堆割裂系统。',
    'features.spv.title': '高压之下也要按预期运行',
    'features.spv.desc': '真正的市场里，稳定比口号重要。TOS 从一开始就减少那些日后代价高昂的不确定性。',
    'features.fairlaunch.title': '三种市场，一个信任根',
    'features.fairlaunch.desc': '应用、资本和隐私可以走不同轨道，但底层共识不会因此被切碎。',
    'features.deflationary.title': '价值流向机会所在',
    'features.deflationary.desc': '原生层和 EVM 之间的价值可以在有机会的地方汇合，而隐私敏感资金则刻意保持隔离。',
    'features.takovm.title': '持续出块，才叫共识',
    'features.takovm.desc': '再漂亮的叙事，如果不能持续稳定出块也没有意义。Catchain 就是背后的纪律系统。',
    'features.community.title': '把你已经信任的工具直接带来',
    'features.community.desc': '开发者不想做科学实验。MetaMask、ethers、Foundry、Hardhat、Remix 都可以直接上手。',
    'features.zkprivacy.title': '更耐时间考验的隐私',
    'features.zkprivacy.desc': '好的隐私不该以未来重写为代价。Uno 从一开始就选择后量子路径，而不是把问题往后拖。',
    'features.cryptography.title': '更新的密码学，更低的迁移代价',
    'features.cryptography.desc': '重点不是术语，而是降低未来安全范式变化时被迫痛苦迁移的概率。',
    'features.parallel.title': '真实基础设施，不是演示样品',
    'features.parallel.desc': 'validator、liteserver 和运维工具已经在栈里，严肃网络在赢得信任之前就该具备这些东西。',
    'features.security.title': '拿证据说话，不靠口号',
    'features.security.desc': '聪明的开发者和严肃的资金都会先看证据。代码、文档、论文和变更记录都摆在台面上。',
    'features.encrypted.title': '掌握网络层，体验才握在手里',
    'features.encrypted.desc': '当更多网络路径由自己掌控，性能、韧性和产品体验的上限也更可控。',
    'features.communication.title': '不只是一条链，更是一个平台',
    'features.communication.desc': '钱包连接、命名和去中心化内容服务，让 TOS 更像可持续构建的平台，而不只是记账本。',
    'features.coreTitle': '为真实需求而设计',
    'features.coreSubtitle': '不同用户要的不是同一种结果。开发者要速度，资本要触达，重要资金要隐私。TOS 不是让所有场景接受同一种妥协，而是给每种需求最合适的环境。',
    'performance.title': '为开发者而建，也让资本看得懂',
    'performance.subtitle': '这些不是堆出来的漂亮数字，而是 TOS 如何更快触达、更广覆盖、更好保护价值的几个明确信号。',
    'stats.workchains.label': '赛道',
    'stats.workchains.desc': '原生应用、以太坊市场、Uno 隐私',
    'stats.node.label': '核心栈',
    'stats.node.desc': '每条赛道下面都是同一张网',
    'stats.cli.label': '运维路径',
    'stats.cli.desc': '从节点到钱包工具，更少摩擦',
    'stats.cadence.label': '市场节奏',
    'stats.cadence.desc': '面向不能等上几分钟的系统',
    'stats.rpc.label': '以太坊适配',
    'stats.rpc.desc': '钱包和工具已经认识这条路',
    'stats.bridges.label': '隐私桥接',
    'stats.bridges.desc': 'Uno 从设计上就是封闭的',
    'stats.state.label': '共享底座',
    'stats.state.desc': '不同赛道，共用一套状态基础',
    'stats.network.label': '网络深度',
    'stats.network.desc': '更多关键栈由自己掌控',
    'docs.title': '从建立信念的地方开始',
    'docs.desc': '谁都能包装一条链，真正建立信念的是文档。这三份材料是理解 TOS 到底能做什么的最快入口。',
    'docs.smartContracts': '先看全局',
    'docs.aiMining': '看市场赛道',
    'docs.exploreAll': '看隐私赛道',
    ...
    'faq.title': '这些问题才真正重要',
    'faq.q1': 'TOS 为什么存在？',
    'faq.a1': '因为单一执行模型很难同时服务好开发者、市场和私密价值。TOS 把高速应用、以太坊接入和真正隐私放进一张网里的不同赛道。',
    'faq.q2': '这样的设计，实际带来了什么？',
    'faq.a2.h1': '给产品团队一条更快的赛道',
    'faq.a2.p1': '当分钟级等待和瓶颈会直接杀死增长时，原生层给你更适合吞吐和扇出的应用环境。',
    'faq.a2.h2': '直接接入以太坊用户和流动性',
    'faq.a2.p2': 'EVM 赛道让熟悉的钱包和工具继续可用，而不是要求市场从头学一遍。',
    'faq.a2.h3': '当暴露成本很高时，有一条真正私密的赛道',
    'faq.a2.p3': '当规模、对手方或时机不该泄露到公开市场时，可以把敏感价值放到 Uno 上。',
    'faq.a2.h4': '更少的运维拖累',
    'faq.a2.p4': '一个 validator-engine 加一条 tosctl 路径，比多链拼接方案更容易跑、也更不容易出错。',
    'faq.a2.h5': '底层仍然只有一个信任根',
    'faq.a2.p5': '不同赛道服务不同任务，但它们依然共享同一个共识故事和同一套状态基础。',
    'faq.q3': '以太坊团队迁过来有多难？',
    'faq.a3': '比从零开始轻得多。现有 Solidity 团队可以把合约、钱包和符合市场习惯的工作方式一起带过来。',
    'faq.q4': '为什么 Uno 要和桥隔离？',
    'faq.a4': '因为价值一旦要经过公开的入口和出口，隐私就开始被破坏。Uno 选择不做这个妥协。',
    'faq.q5': '这只是定位包装，还是已经有真实基础设施？',
    'faq.a5': '仓库里已经有节点栈、运维 CLI、liteserver 路径、构建文档、白皮书和技术参考。这是按基础设施在建设，不只是按叙事在包装。',
    'faq.q6': '为什么说 TOS 更像平台，而不只是账本？',
    'faq.a6': 'Connect、DNS、Sites 和网络栈给开发者的不是单纯结算能力，而是能围绕它真正做产品的一组部件。',
    'faq.q7': '为什么不把一切都塞进一个 VM？',
    'faq.a7': '因为速度、兼容性和隐私在同一个模子里会以不同方式被破坏。分赛道才能各自优化最重要的东西，同时不拆掉底层信任。',
    'faq.bottomText': '如果你想验证这个故事，仓库里就是最直接的凭证。',
  ...
  ja: {
    ...
    'nav.whitepaper': 'ホワイトペーパー',
    'hero.title': 'オープン市場で広げる。<br><span class="highlight">大事な価値はプライベートに。</span>',
    'hero.getTOS': '概要を読む',
    'hero.startMining': 'EVMワークチェーン',
    'features.subtitle': 'ネイティブ層は非同期とシャーディングを前提に、速度と拡張性を取りにいきます。EVM層は同期的な使い心地を保ち、Ethereumアプリをそのまま受け入れます。Unoは表に出したくない価値を扱います。',
    'features.did.title': '速く立ち上げ、失速しにくい',
    'features.did.desc': '高速なファンアウトや高負荷下の応答性が必要なアプリ向けです。単線型チェーンの詰まりを避けやすくします。',
    'features.agiw.title': '作り直さずにEthereum市場へ',
    'features.agiw.desc': 'Solidity資産、ウォレット、ユーザー習慣をそのまま持ち込めます。TOSは市場参入をやり直しにしません。',
    'features.credits.title': '大事な価値のためのプライバシー',
    'features.credits.desc': '金額、相手、タイミングを広く見せたくない場面で、Unoは最初からプライバシーのために設計されたレールになります。',
    'features.performance.title': '継ぎはぎではなく、1つのネットワーク',
    'features.performance.desc': '別々のチェーンやsidecarを縫い合わせる代わりに、1つの中核スタックで運べます。',
    'features.trilemma.title': '運用を摩擦にしない',
    'features.trilemma.desc': 'ノード運用、ウォレット操作、ワークチェーン作業を1つの操作面に寄せることで、負荷もミスも減らせます。',
    'features.instant.title': 'ビルダーの入口は1つでいい',
    'features.instant.desc': '独自の接着コードを増やす代わりに、開発者が必要なレールへ1つの入口から入れます。',
    'features.pruning.title': '1つの状態基盤で、複雑さを減らす',
    'features.pruning.desc': '実行モデルが増えても、土台が分断された別システムの山になりにくい設計です。',
    'features.spv.title': 'プレッシャー下でも期待通りに動く',
    'features.spv.desc': '実際の市場では安定性が重要です。後で高くつく不確実性を最初から減らす考え方です。',
    'features.fairlaunch.title': '3つの市場、1つの信頼の根',
    'features.fairlaunch.desc': 'アプリ、資本、プライバシーが別レールにいても、下の信頼基盤はばらばらになりません。',
    'features.deflationary.title': '価値は機会のある場所へ動く',
    'features.deflationary.desc': 'ネイティブとEVMの価値は機会がある場所で交わり、プライバシー重視の価値は意図的に隔離されます。',
    'features.takovm.title': '動き続けるコンセンサス',
    'features.takovm.desc': 'どれだけ美しい物語でも、安定してブロックを出せなければ意味がありません。Catchainはその継続を支える規律です。',
    'features.community.title': 'すでに信頼している道具を持ち込める',
    'features.community.desc': '開発者は実験台を求めていません。MetaMask、ethers、Foundry、Hardhat、Remixがそのまま市場投入の流れに乗ります。',
    'features.zkprivacy.title': '時間に強いプライバシー',
    'features.zkprivacy.desc': '良いプライバシーは将来の全面書き換えを前提にすべきではありません。Unoは問題を先送りしません。',
    'features.cryptography.title': '新しい暗号で、移行リスクを下げる',
    'features.cryptography.desc': '大事なのは専門用語ではなく、将来の安全性の変化が痛い移行を強制する確率を下げることです。',
    'features.parallel.title': 'デモではなく、本物の基盤',
    'features.parallel.desc': 'validator、liteserver、運用ツールが最初から入っていることは、信頼を積み上げるネットワークに必要です。',
    'features.security.title': '約束ではなく、証拠',
    'features.security.desc': '賢いビルダーも真剣な資本も、まず証拠を見ます。コード、文書、論文、変更履歴を確認できます。',
    'features.encrypted.title': 'ネットワーク層を握る',
    'features.encrypted.desc': 'ネットワーク経路をより多く自分で持つほど、性能、強靭さ、体験の主導権を持てます。',
    'features.communication.title': 'ただのチェーンでは終わらない',
    'features.communication.desc': 'ウォレット接続、命名、分散配信まで含むことで、TOSは単なる台帳ではなく構築可能な基盤になります。',
    'features.coreTitle': '実需のために設計',
    'features.coreSubtitle': '求める結果は1つではありません。ビルダーは速度、資本は到達性、重要な資産はプライバシーを求めます。TOSはそれぞれに合った環境を用意します。',
    'performance.title': 'ビルダーのために作り、資本にも伝わる',
    'performance.subtitle': 'これは見栄えの数字ではありません。TOSがどう速く広がり、より広く届き、価値を守るかを示す信号です。',
    'stats.workchains.label': 'レール',
    'stats.workchains.desc': 'ネイティブアプリ、Ethereum到達性、Unoプライバシー',
    'stats.node.label': '中核スタック',
    'stats.node.desc': 'すべてのレールの下に同じネットワーク',
    'stats.cli.label': '運用導線',
    'stats.cli.desc': 'ノードからウォレット運用まで摩擦を減らす',
    'stats.cadence.label': '市場のテンポ',
    'stats.cadence.desc': '分単位で待てないシステムのために',
    'stats.rpc.label': 'Ethereum適合',
    'stats.rpc.desc': 'ウォレットもツールもこの道を知っている',
    'stats.bridges.label': 'プライバシーブリッジ',
    'stats.bridges.desc': 'Unoは設計上、閉じたままです',
    'stats.state.label': '共有基盤',
    'stats.state.desc': '異なるレールでも状態基盤は1つ',
    'stats.network.label': 'ネットワーク深度',
    'stats.network.desc': 'より多くの重要スタックを自前で持つ',
    'docs.title': '確信が生まれる場所から始める',
    'docs.desc': 'チェーンは誰でも売り込めます。本当に重要なのは、TOSが何を出荷できるかを最短で理解できる文書です。',
    'docs.smartContracts': 'まず全体を見る',
    'docs.aiMining': '市場レールを見る',
    'docs.exploreAll': 'プライバシーレールを見る',
    ...
    'faq.a1': '1つの実行モデルでは、ビルダー、市場、そして私的な価値を同時にうまく支えにくいからです。TOSは高速アプリ、Ethereumへの到達性、本物のプライバシーを1つのネットワーク内の別々のレールとして用意します。',
    'faq.q2': 'その設計で、実際に何が得られますか？',
    'faq.a2.h1': 'プロダクトを作る人のための、より速いレール',
    'faq.a2.p1': '分単位の待ち時間やボトルネックが勢いを殺す場面でも、スループットとファンアウトに向いたネイティブ層で立ち上げられます。',
    'faq.a2.h2': 'Ethereumのユーザーと流動性への直通路',
    'faq.a2.p2': '市場にすべてを学び直させるのではなく、馴染みのあるウォレットとツールを保ったままEVMレールを使えます。',
    'faq.a2.h3': '露出コストが高いときの、私的なレール',
    'faq.a2.p3': '規模、相手、タイミングを表に出したくない価値はUnoで動かせます。',
    'faq.a2.h4': '運用の重さを減らす',
    'faq.a2.p4': '1つのvalidator-engineと1つのtosctl経路で、継ぎはぎのマルチチェーン構成より運用しやすくなります。',
    'faq.a2.h5': 'その下にある信頼基盤は1つ',
    'faq.a2.p5': 'レールごとに役割は違っても、共有するのは同じコンセンサスの物語と同じ状態基盤です。',
    'faq.q3': 'Ethereumチームが入ってくるのはどれくらい大変ですか？',
    'faq.a3': 'ゼロから始めるよりずっと軽いです。既存のSolidityチームは、契約、ウォレット、市場に合った習慣をそのまま持ち込めます。',
    'faq.q4': 'なぜUnoをブリッジから切り離すのですか？',
    'faq.a4': '価値が公開の入口と出口を通る瞬間から、プライバシーは崩れ始めるからです。Unoはその妥協を拒みます。',
    'faq.q5': 'これは言い回しだけですか、それとも実際の基盤がありますか？',
    'faq.a5': 'リポジトリにはすでにノードスタック、運用CLI、liteserver経路、ビルド文書、ホワイトペーパー、技術資料があります。物語ではなく、基盤として作られています。',
    'faq.q6': 'なぜTOSは台帳ではなく、プラットフォームのように見えるのですか？',
    'faq.a6': 'Connect、DNS、Sites、そしてネットワークスタックが、単なる決済以上のものをビルダーに渡します。実際にプロダクトを組み立てられる部品です。',
    'faq.q7': 'なぜすべてを1つのVMに押し込まないのですか？',
    'faq.a7': '速度、互換性、プライバシーは、同じ型に押し込むとそれぞれ別の壊れ方をするからです。レールを分けることで、信頼を分断せずに本当に重要なものを最適化できます。',
    'faq.bottomText': 'このストーリーを確かめたいなら、リポジトリがその証拠です。',
  ...
  ko: {
    ...
    'nav.whitepaper': '백서',
    'hero.title': '오픈 마켓을 향해 구축하고.<br><span class="highlight">중요한 가치는 비공개로 지키세요.</span>',
    'hero.getTOS': '개요 읽기',
    'hero.startMining': 'EVM 워크체인',
    'features.subtitle': '네이티브 레이어는 비동기와 샤딩을 전제로, 속도와 확장성을 함께 가져갑니다. EVM 레이어는 동기적 사용감을 유지해 Ethereum 앱이 익숙하게 들어오게 합니다. Uno는 드러나지 말아야 할 가치를 맡습니다.',
    'features.did.title': '빠르게 출시하고, 병목에 덜 묶이세요',
    'features.did.desc': '빠른 팬아웃과 고부하 응답성이 필요한 앱을 위한 레이어입니다. 단일 레인 체인의 병목을 줄이는 데 유리합니다.',
    'features.agiw.title': '처음부터 다시 만들지 말고 Ethereum으로 가세요',
    'features.agiw.desc': 'Solidity 자산, 지갑, 사용자 습관을 그대로 가져오세요. TOS는 시장 진입을 재시작으로 만들지 않습니다.',
    'features.credits.title': '중요한 가치에 맞는 프라이버시',
    'features.credits.desc': '금액, 상대방, 타이밍을 널리 드러내고 싶지 않을 때 Uno는 처음부터 프라이버시를 위해 설계된 레일이 됩니다.',
    'features.performance.title': '짜깁기가 아닌 하나의 네트워크',
    'features.performance.desc': '여러 체인과 sidecar를 억지로 엮는 대신, 하나의 핵심 스택으로 운영할 수 있습니다.',
    'features.trilemma.title': '운영이 마찰이 되지 않게',
    'features.trilemma.desc': '노드 운영, 지갑 흐름, 워크체인 도구를 하나의 제어면으로 묶으면 비용도 실수도 줄어듭니다.',
    'features.instant.title': '빌더에게는 하나의 입구면 충분합니다',
    'features.instant.desc': '개발자에게 또 다른 접착 코드를 강요하지 않습니다. 필요한 레일을 하나의 입구에서 제공합니다.',
    'features.pruning.title': '하나의 상태 기반, 더 낮은 복잡도',
    'features.pruning.desc': '실행 모델이 늘어나도 바닥이 잘린 여러 시스템 더미로 변하지 않도록 돕습니다.',
    'features.spv.title': '압박 속에서도 예상대로 움직이게',
    'features.spv.desc': '실제 시장에서는 안정성이 중요합니다. 나중에 비싸지는 불확실성을 초기에 줄이기 위한 설계입니다.',
    'features.fairlaunch.title': '세 가지 시장, 하나의 신뢰 루트',
    'features.fairlaunch.desc': '앱, 자본, 프라이버시가 다른 레일에 있어도 아래의 신뢰 기반은 쪼개지지 않습니다.',
    'features.deflationary.title': '가치는 기회가 있는 곳으로 흐릅니다',
    'features.deflationary.desc': '네이티브와 EVM의 가치는 기회가 있는 곳에서 만나고, 프라이버시 민감 자산은 의도적으로 분리됩니다.',
    'features.takovm.title': '계속 전진하는 합의',
    'features.takovm.desc': '아무리 좋은 이야기라도 안정적으로 블록을 만들지 못하면 의미가 없습니다. Catchain은 그 지속성을 지탱하는 규율입니다.',
    'features.community.title': '이미 믿는 도구를 그대로 가져오세요',
    'features.community.desc': '개발자는 실험실 프로젝트를 원하지 않습니다. MetaMask, ethers, Foundry, Hardhat, Remix가 그대로 시장 진입 경로에 들어옵니다.',
    'features.zkprivacy.title': '시간이 지나도 덜 낡는 프라이버시',
    'features.zkprivacy.desc': '좋은 프라이버시는 미래의 전면 재작성 비용을 전제로 해서는 안 됩니다. Uno는 문제를 뒤로 미루지 않습니다.',
    'features.cryptography.title': '더 현대적인 암호, 더 낮은 마이그레이션 리스크',
    'features.cryptography.desc': '중요한 것은 용어가 아니라, 미래의 보안 변화가 고통스러운 이전을 강제할 가능성을 낮추는 일입니다.',
    'features.parallel.title': '데모가 아닌 실제 인프라',
    'features.parallel.desc': 'validator, liteserver, 운영 도구가 처음부터 들어 있다는 점은 신뢰를 쌓아야 하는 네트워크에 필수입니다.',
    'features.security.title': '약속보다 증거',
    'features.security.desc': '영리한 빌더와 진지한 자본은 먼저 증거를 봅니다. 코드, 문서, 논문, 변경 기록을 직접 확인할 수 있습니다.',
    'features.encrypted.title': '네트워크 레이어를 직접 쥐세요',
    'features.encrypted.desc': '네트워크 경로를 더 많이 통제할수록 성능, 회복력, 제품 경험도 더 많이 통제할 수 있습니다.',
    'features.communication.title': '그냥 체인으로 끝나지 않습니다',
    'features.communication.desc': '지갑 연결, 네이밍, 분산 서빙까지 갖추면 TOS는 단순한 원장이 아니라 구축 가능한 플랫폼에 가까워집니다.',
    'features.coreTitle': '실수요를 위해 설계',
    'features.coreSubtitle': '원하는 결과는 하나가 아닙니다. 빌더는 속도를, 자본은 도달 범위를, 중요한 자금은 프라이버시를 원합니다. TOS는 모든 사용례를 같은 타협에 가두지 않고 각자에게 맞는 환경을 제공합니다.',
    'performance.title': '빌더를 위해 만들고, 자본도 이해하게',
    'performance.subtitle': '이건 보기 좋은 숫자가 아닙니다. TOS가 더 빠르게 닿고, 더 넓게 퍼지고, 가치를 더 잘 지키는 방식을 보여주는 신호입니다.',
    'stats.workchains.label': '레일',
    'stats.workchains.desc': '네이티브 앱, Ethereum 접근성, Uno 프라이버시',
    'stats.node.label': '핵심 스택',
    'stats.node.desc': '모든 레일 아래에는 같은 네트워크',
    'stats.cli.label': '운영 경로',
    'stats.cli.desc': '노드에서 지갑 도구까지 마찰을 줄임',
    'stats.cadence.label': '시장 리듬',
    'stats.cadence.desc': '몇 분씩 기다릴 수 없는 시스템을 위해',
    'stats.rpc.label': 'Ethereum 적합성',
    'stats.rpc.desc': '지갑과 도구가 이미 아는 길',
    'stats.bridges.label': '프라이버시 브리지',
    'stats.bridges.desc': 'Uno는 설계상 봉인되어 있습니다',
    'stats.state.label': '공유 기반',
    'stats.state.desc': '다른 레일, 하나의 상태 기반',
    'stats.network.label': '네트워크 깊이',
    'stats.network.desc': '더 많은 핵심 스택을 직접 통제',
    'docs.title': '확신이 시작되는 곳에서 출발',
    'docs.desc': '체인은 누구나 포장할 수 있습니다. TOS가 실제로 무엇을 낼 수 있는지 가장 빨리 이해하게 해 주는 문서부터 보세요.',
    'docs.smartContracts': '먼저 전체를 보기',
    'docs.aiMining': '시장 레일 보기',
    'docs.exploreAll': '프라이버시 레일 보기',
    ...
    'faq.q1': 'TOS는 왜 존재하나요?',
    'faq.a1': '하나의 실행 모델만으로는 빌더, 시장, 그리고 사적인 가치를 동시에 잘 받쳐 주기 어렵기 때문입니다. TOS는 빠른 앱, Ethereum 접근성, 진짜 프라이버시를 하나의 네트워크 안의 다른 레일로 제공합니다.',
    'faq.q2': '그 설계로 실제로 무엇을 얻나요?',
    'faq.a2.h1': '제품 팀을 위한 더 빠른 레일',
    'faq.a2.p1': '몇 분의 대기와 병목이 성장 자체를 죽이는 상황에서, 처리량과 팬아웃에 맞는 네이티브 레이어 위에서 앱을 올릴 수 있습니다.',
    'faq.a2.h2': 'Ethereum 사용자와 유동성으로 가는 직통선',
    'faq.a2.p2': '시장이 모든 것을 다시 배우게 하는 대신, 익숙한 지갑과 도구를 그대로 쓰는 EVM 레일을 사용할 수 있습니다.',
    'faq.a2.h3': '노출 비용이 클 때 필요한 프라이빗 레일',
    'faq.a2.p3': '규모, 상대방, 타이밍이 공개로 새면 안 되는 민감한 가치는 Uno에서 움직일 수 있습니다.',
    'faq.a2.h4': '더 적은 운영 부담',
    'faq.a2.p4': '하나의 validator-engine와 하나의 tosctl 경로로, 짜깁기한 멀티체인 구성보다 더 단순하게 운영할 수 있습니다.',
    'faq.a2.h5': '그 아래에는 하나의 신뢰 기반',
    'faq.a2.p5': '레일마다 맡는 일은 달라도, 공유하는 것은 하나의 합의 서사와 하나의 상태 기반입니다.',
    'faq.q3': 'Ethereum 팀이 들어오는 건 얼마나 어렵나요?',
    'faq.a3': '제로에서 시작하는 것보다 훨씬 쉽습니다. 기존 Solidity 팀은 컨트랙트, 지갑, 그리고 시장에 맞는 습관을 그대로 가져올 수 있습니다.',
    'faq.q4': '왜 Uno를 브리지와 분리하나요?',
    'faq.a4': '가치가 공개된 입구와 출구를 통과하는 순간부터 프라이버시는 깨지기 시작하기 때문입니다. Uno는 그 타협을 거부합니다.',
    'faq.q5': '이건 포지셔닝 문구일 뿐인가요, 아니면 실제 인프라가 있나요?',
    'faq.a5': '저장소에는 이미 노드 스택, 운영 CLI, liteserver 경로, 빌드 문서, 백서, 기술 참고자료가 있습니다. 이것은 서사가 아니라 인프라로 만들어지고 있습니다.',
    'faq.q6': '왜 TOS는 원장보다 플랫폼처럼 느껴지나요?',
    'faq.a6': 'Connect, DNS, Sites, 그리고 네트워킹 스택은 빌더에게 결제 이상의 것을 줍니다. 실제 제품을 조립할 수 있는 부품입니다.',
    'faq.q7': '왜 모든 것을 하나의 VM에 넣지 않나요?',
    'faq.a7': '속도, 호환성, 프라이버시는 같은 틀에 억지로 넣으면 각기 다른 방식으로 망가지기 때문입니다. 레일을 나누면 신뢰를 쪼개지 않고도 정말 중요한 것을 최적화할 수 있습니다.',
    'faq.bottomText': '이 이야기를 검증하고 싶다면, 저장소가 가장 직접적인 증거입니다.',
