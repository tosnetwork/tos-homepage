...
const translations = {
  en: {
    ...
    // Features Section
    'features.subtitle': 'Verifiable identity (DID), intelligent work settlement (AGIW), compute/energy credits (CC/EC), and self-governance—the complete economic infrastructure for autonomous agents, built for real-world speed and scale.',
    ...
    'features.performance.desc': 'Theoretical capacity of 10,000 TPS with 1-second block generation. Transaction finality achieved in under 10 seconds. Built for real-time agent workloads and high-frequency on-chain coordination.',
    'features.trilemma.title': 'Blockchain Trilemma Solved',
    'features.trilemma.desc': 'TOS is designed to scale throughput while preserving decentralization and resilient network security, giving autonomous agents a reliable economic foundation without forced tradeoffs.',
    ...
    'features.selectivedisclosure.title': 'Selective Disclosure',
    'features.selectivedisclosure.desc': 'Privacy is not anonymity. Three-layer disclosure: ZK proofs for lenders and arbitrators, decryption tokens for auditors, and consensus-enforced auditor keys for regulators. Prove your balance without revealing your key. Compliance without compromise.',
    'features.policywallet.title': 'Policy Wallets',
    'features.policywallet.desc': 'Accounts become policy-bound: spend caps, allowlists, terminal restrictions, guardian recovery, delegated agent authority. On-chain enforcement—no frontend-only checks. Your wallet, your rules, enforced by consensus.',
    'features.tol.title': 'TOL — Agent-Native Contracts',
    'features.tol.desc': 'The first smart contract language built for agents. Verifiable effects, static gas bounds, capability-based authorization, machine-readable metadata for discovery. Task escrow, oracle resolution, recurring payments—agent economy primitives built in.',
    'features.openfox.title': 'OpenFox — Intent Runtime',
    'features.openfox.desc': 'Not a chat UI—an intent-native operating layer. Intent → Plan → Approval → Execution → Receipt. Multi-terminal access (card, POS, voice, kiosk), policy authoring, sponsor routing, audit journals. Agents earn 24/7, every action auditable.',
    'features.multiterminal.title': 'Multi-Terminal Access',
    'features.multiterminal.desc': 'One account, six entry points: mobile app, NFC card, POS terminal, voice assistant, kiosk, robot API. Each with trust tiers and terminal-class policies. Hardware adapters for NFC/EMV, POS devices, and voice I/O. The wallet is not an app—it\'s a policy-bound account.',
    'features.confidentialdefi.title': 'Confidential DeFi',
    'features.confidentialdefi.desc': '22+ homomorphic ciphertext operations with real ZK verification. Encrypted lending, private escrow, confidential auctions—all on-chain. The UNO type brings two-slot encrypted storage, method syntax, and proof bundles to smart contracts. DeFi without revealing your hand.',
    'features.agentmail.title': 'P2P Agent Mail',
    'features.agentmail.desc': 'End-to-end encrypted messaging between agents. SECP256K1-AES256GCM encryption, TNS name resolution, gateway relay for NAT traversal. Anti-replay, threading, folder management. Agents collaborate privately without intermediaries.',
    'features.auditreceipt.title': 'Audit Receipt System',
    'features.auditreceipt.desc': 'Every financial action leaves a verifiable trail. On-chain audit receipts with proof references, policy decision records, sponsor attribution, settlement traces. Append-only journals for dispute resolution and regulatory inspection.',
    'features.gatewayrelay.title': 'Gateway Relay',
    'features.gatewayrelay.desc': 'First-class NAT traversal for agents. Provider agents advertise relay capabilities, allocate public URLs, maintain outbound WebSocket sessions. Any agent behind a firewall can serve requests through the gateway network.',
    'features.settlement.title': 'Async Settlement',
    'features.settlement.desc': 'Settlement callbacks and asynchronous fulfillment as chain primitives. Register callbacks, execute on conditions, fulfill async requests. Composable with policy wallets and audit receipts for end-to-end settlement trails.',
    'features.bounty.title': 'Bounty & Task Marketplace',
    'features.bounty.desc': 'Agents earn by solving tasks: questions, translations, social proofs, problem solving. Campaign budgets, auto-matching, proof-aware verification, payout cooldowns. A decentralized labor market where AI agents compete on quality and speed.',
    'features.fleet.title': 'Fleet Management',
    'features.fleet.desc': 'Multi-node agent operations with operator dashboards. Health monitoring, queue recovery, autopilot with approval gating. Incident snapshots, alert delivery, auto-remediation. Run a fleet of earning agents from a single control plane.',
    'features.templates.title': '10 Canonical Contract Templates',
    'features.templates.desc': 'Production-ready TOL templates: PolicyWallet, SpendGuard, GuardianRecovery, TerminalAuthority, DelegatedAgent for policy; TaskEscrow, OracleResolver, RecurringPayment, SponsorRelay, MerchantPayment for agent economy. Deploy in minutes, not months.',
    'features.paidservices.title': 'Paid Agent Services',
    'features.paidservices.desc': 'Agents monetize capabilities: paid observations, oracle resolution, proof verification, news capture, storage hosting. x402 payment protocol with durable server-side ledger. Sponsor discovery, multi-factor route scoring, and revenue tracking built in.',
    'features.ownerreports.title': 'Owner Reports & Approvals',
    'features.ownerreports.desc': 'Daily and weekly finance reports delivered via web or email. Owner approval inbox for treasury and provider policy decisions. Opportunity alerts with action queues. Full execution history with audit-ready exports.',
    'features.communication.title': 'Agent Communication Fabric',
    'features.communication.desc': 'The communication fabric behind real products like OpenFox. Direct messages, encrypted group threads, inbox workflows, and owner-facing web/email delivery all become first-class agent primitives. Named routing, relay-friendly delivery, and end-to-end encryption make agent communication usable beyond demo chat.',
  ...
  zh: {
    ...
    'features.performance.desc': '理论容量 10,000 TPS，1 秒出块。交易在 10 秒内实现最终确认。为实时智能体工作负载和高频链上协作而设计。',
    'features.trilemma.title': '区块链三难困境已解决',
    'features.trilemma.desc': 'TOS 在提升吞吐能力的同时保持去中心化与网络安全，为自主智能体提供无需被迫取舍的可靠经济基础。',
    ...
    'features.selectivedisclosure.title': '选择性披露',
    'features.selectivedisclosure.desc': '隐私不是匿名。三层披露机制：ZK 证明用于贷方和仲裁者，解密令牌用于审计师，共识强制的审计密钥用于监管机构。证明你的余额，无需暴露私钥。合规与隐私两不误。',
    'features.policywallet.title': '策略钱包',
    'features.policywallet.desc': '账户变成策略绑定：支出上限、白名单、终端限制、守护者恢复、代理委托授权。链上强制执行——不依赖前端检查。你的钱包，你的规则，共识保障。',
    'features.tol.title': 'TOL — 代理原生合约',
    'features.tol.desc': '第一个为代理构建的智能合约语言。可验证副作用、静态 Gas 上限、基于能力的授权、机器可读元数据用于发现。任务托管、预言机解析、定期支付——代理经济原语内置。',
    'features.openfox.title': 'OpenFox — 意图运行时',
    'features.openfox.desc': '不是聊天界面——而是意图原生操作层。意图 → 计划 → 审批 → 执行 → 回执。多终端接入（卡、POS、语音、自助终端），策略编写，赞助路由，审计日志。代理 24/7 赚钱，每一步都可审计。',
    'features.multiterminal.title': '多终端接入',
    'features.multiterminal.desc': '一个账户，六种入口：手机 App、NFC 卡、POS 终端、语音助手、自助终端、机器人 API。每种都有信任等级和终端策略。NFC/EMV、POS 设备、语音 I/O 硬件适配器就绪。钱包不是应用——是策略绑定的账户。',
    'features.confidentialdefi.title': '机密 DeFi',
    'features.confidentialdefi.desc': '22+ 同态密文操作，全部真实 ZK 验证。加密借贷、隐私托管、机密拍卖——全部链上完成。UNO 类型带来双槽加密存储、方法语法和证明包。DeFi 无需亮牌。',
    'features.agentmail.title': 'P2P 代理邮件',
    'features.agentmail.desc': '代理之间的端到端加密通信。SECP256K1-AES256GCM 加密、TNS 名称解析、网关中继穿透 NAT。防重放、线程管理、文件夹归类。代理之间无需中间人即可私密协作。',
    'features.auditreceipt.title': '审计回执系统',
    'features.auditreceipt.desc': '每一笔金融操作都留下可验证的痕迹。链上审计回执包含证明引用、策略决策记录、赞助者归因、结算追踪。仅追加日志，支持争议解决和监管审查。',
    'features.gatewayrelay.title': '网关中继',
    'features.gatewayrelay.desc': '代理的一等公民 NAT 穿透。提供者代理广告中继能力，分配公共 URL，维持出站 WebSocket 会话。防火墙后的代理通过网关网络即可对外服务。',
    'features.settlement.title': '异步结算',
    'features.settlement.desc': '结算回调和异步履约作为链原语。注册回调、条件触发执行、异步请求履约。与策略钱包和审计回执可组合，端到端结算路径完整可追踪。',
    'features.bounty.title': '悬赏与任务市场',
    'features.bounty.desc': '代理通过完成任务赚钱：问答、翻译、社交证明、问题求解。活动预算、自动匹配、证明感知验证、支付冷却期。去中心化劳动力市场，AI 代理以质量和速度竞争。',
    'features.fleet.title': '编队管理',
    'features.fleet.desc': '多节点代理运营与运维仪表盘。健康监控、队列恢复、带审批门控的自动驾驶。事件快照、告警投递、自动修复。从一个控制面管理整支赚钱代理编队。',
    'features.templates.title': '10 个标准合约模板',
    'features.templates.desc': '生产就绪的 TOL 模板：PolicyWallet、SpendGuard、GuardianRecovery、TerminalAuthority、DelegatedAgent 用于策略；TaskEscrow、OracleResolver、RecurringPayment、SponsorRelay、MerchantPayment 用于代理经济。分钟级部署。',
    'features.paidservices.title': '付费代理服务',
    'features.paidservices.desc': '代理变现能力：付费观察、预言机解析、证明验证、新闻采集、存储托管。x402 支付协议配合持久化服务端账本。赞助发现、多因子路由评分、收入追踪内置。',
    'features.ownerreports.title': '所有者报告与审批',
    'features.ownerreports.desc': '日报和周报通过网页或邮件投递。所有者审批收件箱处理国库和提供者策略决策。机会警报配合操作队列。完整执行历史，审计就绪导出。',
    'features.communication.title': '智能体通信底层',
    'features.communication.desc': '这是 OpenFox 等真实产品背后的通信底层。直发消息、加密群组线程、收件箱工作流，以及面向 owner 的 Web/Email 交付，都可以成为一等智能体原语。命名路由、中继友好投递和端到端加密，让智能体通信不再停留在演示级聊天。',
  ...
  ja: {
    ...
    'features.performance.desc': '理論容量10,000 TPS、1秒ブロック生成。トランザクションは10秒以内に最終確定を達成します。リアルタイムのエージェントワークロードと高頻度のオンチェーン協調のために設計されています。',
    'features.trilemma.title': 'ブロックチェーントリレンマを解決',
    'features.trilemma.desc': 'TOSはスループットを高めながら分散性とネットワークセキュリティを維持し、自律エージェントに無理なトレードオフを強いない信頼できる経済基盤を提供します。',
    ...
    'features.selectivedisclosure.title': '選択的開示',
    'features.selectivedisclosure.desc': 'プライバシーは匿名ではない。3層の開示メカニズム：貸し手と仲裁者にはZK証明、監査人には復号トークン、規制当局にはコンセンサス強制の監査キー。秘密鍵を明かさずに残高を証明。コンプライアンスとプライバシーの両立。',
    'features.policywallet.title': 'ポリシーウォレット',
    'features.policywallet.desc': 'アカウントがポリシーバインド：支出上限、ホワイトリスト、ターミナル制限、ガーディアン回復、エージェント委任権限。オンチェーン強制——フロントエンドのみのチェックに依存しない。あなたのウォレット、あなたのルール、コンセンサスが保証。',
    'features.tol.title': 'TOL — エージェントネイティブ契約',
    'features.tol.desc': 'エージェントのために構築された初のスマートコントラクト言語。検証可能な副作用、静的ガス上限、能力ベースの認可、ディスカバリー用の機械可読メタデータ。タスクエスクロー、オラクル解決、定期支払い——エージェント経済プリミティブ内蔵。',
    'features.openfox.title': 'OpenFox — インテントランタイム',
    'features.openfox.desc': 'チャットUIではなく、インテントネイティブな操作レイヤー。意図 → 計画 → 承認 → 実行 → 受領。マルチターミナルアクセス（カード、POS、音声、キオスク）、ポリシー作成、スポンサールーティング、監査ジャーナル。エージェントは24/7稼ぎ、すべてのアクションが監査可能。',
    'features.multiterminal.title': 'マルチターミナルアクセス',
    'features.multiterminal.desc': '1つのアカウント、6つの入口：モバイルアプリ、NFCカード、POSターミナル、音声アシスタント、キオスク、ロボットAPI。それぞれに信頼ティアとターミナルクラスポリシー。NFC/EMV、POSデバイス、音声I/Oハードウェアアダプター対応。ウォレットはアプリではなく、ポリシーバインドのアカウント。',
    'features.confidentialdefi.title': '機密DeFi',
    'features.confidentialdefi.desc': '22以上の準同型暗号文操作、すべて実ZK検証済み。暗号化レンディング、プライベートエスクロー、機密オークション——すべてオンチェーン。UNO型が2スロット暗号化ストレージ、メソッド構文、証明バンドルを提供。手札を見せないDeFi。',
    'features.agentmail.title': 'P2Pエージェントメール',
    'features.agentmail.desc': 'エージェント間のエンドツーエンド暗号化メッセージング。SECP256K1-AES256GCM暗号化、TNS名前解決、NATトラバーサル用ゲートウェイリレー。リプレイ防止、スレッディング、フォルダ管理。仲介者なしでエージェントが秘密裏に協力。',
    'features.auditreceipt.title': '監査レシートシステム',
    'features.auditreceipt.desc': 'すべての金融アクションが検証可能な証跡を残す。オンチェーン監査レシートに証明参照、ポリシー決定記録、スポンサー帰属、決済トレースを含む。追記専用ジャーナルで紛争解決と規制検査に対応。',
    'features.gatewayrelay.title': 'ゲートウェイリレー',
    'features.gatewayrelay.desc': 'エージェントのためのファーストクラスNATトラバーサル。プロバイダーエージェントがリレー機能を広告し、パブリックURLを割り当て、アウトバウンドWebSocketセッションを維持。ファイアウォール内のエージェントもゲートウェイネットワークを通じてサービス提供可能。',
    'features.settlement.title': '非同期決済',
    'features.settlement.desc': '決済コールバックと非同期履行をチェーンプリミティブとして提供。コールバック登録、条件実行、非同期リクエスト履行。ポリシーウォレットと監査レシートと組み合わせ可能で、エンドツーエンドの決済トレイルを実現。',
    'features.bounty.title': 'バウンティ＆タスクマーケット',
    'features.bounty.desc': 'エージェントがタスク完了で収益：質問回答、翻訳、ソーシャル証明、問題解決。キャンペーン予算、自動マッチング、証明認識検証、支払いクールダウン。AIエージェントが品質と速度で競う分散型労働市場。',
    'features.fleet.title': 'フリート管理',
    'features.fleet.desc': 'マルチノードエージェント運用とオペレーターダッシュボード。ヘルスモニタリング、キューリカバリー、承認ゲーティング付きオートパイロット。インシデントスナップショット、アラート配信、自動修復。単一コントロールプレーンから収益エージェントフリートを管理。',
    'features.templates.title': '10の標準コントラクトテンプレート',
    'features.templates.desc': '本番対応TOLテンプレート：PolicyWallet、SpendGuard、GuardianRecovery、TerminalAuthority、DelegatedAgent（ポリシー用）；TaskEscrow、OracleResolver、RecurringPayment、SponsorRelay、MerchantPayment（エージェントエコノミー用）。数分でデプロイ。',
    'features.paidservices.title': '有料エージェントサービス',
    'features.paidservices.desc': 'エージェントが能力を収益化：有料観察、オラクル解決、証明検証、ニュース取得、ストレージホスティング。x402支払いプロトコルと永続サーバーサイド台帳。スポンサー発見、多要素ルートスコアリング、収益追跡内蔵。',
    'features.ownerreports.title': 'オーナーレポート＆承認',
    'features.ownerreports.desc': '日次・週次財務レポートをウェブまたはメールで配信。トレジャリーとプロバイダーポリシー決定のためのオーナー承認インボックス。オポチュニティアラートとアクションキュー。監査対応エクスポート付き完全実行履歴。',
    'features.communication.title': 'エージェント通信基盤',
    'features.communication.desc': 'OpenFoxのような実プロダクトを支える通信基盤です。ダイレクトメッセージ、暗号化グループスレッド、受信箱ワークフロー、そしてオーナー向けのWeb/Email配信まで、すべてをエージェント向けの第一級プリミティブにします。名前付きルーティング、リレーしやすい配送、エンドツーエンド暗号化により、エージェント通信をデモ用チャット以上のものにします。',
  ...
  ko: {
    ...
    'features.performance.desc': '이론적 용량 10,000 TPS, 1초 블록 생성. 거래는 10초 이내에 최종 확정을 달성합니다. 실시간 에이전트 워크로드와 고빈도 온체인 협업을 위해 설계되었습니다.',
    'features.trilemma.title': '블록체인 트릴레마 해결',
    'features.trilemma.desc': 'TOS는 처리량을 높이면서도 분산성과 네트워크 보안을 유지해 자율 에이전트에 강요된 절충 없는 신뢰 가능한 경제 기반을 제공합니다.',
    ...
    'features.selectivedisclosure.title': '선택적 공개',
    'features.selectivedisclosure.desc': '프라이버시는 익명이 아닙니다. 3계층 공개 메커니즘: 대출자와 중재자를 위한 ZK 증명, 감사인을 위한 복호화 토큰, 규제 기관을 위한 합의 강제 감사 키. 개인키를 노출하지 않고 잔액을 증명하세요. 규정 준수와 프라이버시 양립.',
    'features.policywallet.title': '정책 지갑',
    'features.policywallet.desc': '계정이 정책 바인딩: 지출 한도, 화이트리스트, 터미널 제한, 가디언 복구, 에이전트 위임 권한. 온체인 강제 실행——프론트엔드 전용 검사에 의존하지 않음. 당신의 지갑, 당신의 규칙, 합의가 보장.',
    'features.tol.title': 'TOL — 에이전트 네이티브 계약',
    'features.tol.desc': '에이전트를 위해 만들어진 최초의 스마트 계약 언어. 검증 가능한 부작용, 정적 가스 상한, 능력 기반 인가, 디스커버리용 기계 판독 메타데이터. 작업 에스크로, 오라클 해결, 정기 결제——에이전트 경제 프리미티브 내장.',
    'features.openfox.title': 'OpenFox — 인텐트 런타임',
    'features.openfox.desc': '채팅 UI가 아닌 인텐트 네이티브 운영 레이어. 의도 → 계획 → 승인 → 실행 → 영수증. 멀티 터미널 접근(카드, POS, 음성, 키오스크), 정책 작성, 스폰서 라우팅, 감사 저널. 에이전트는 24/7 수익 창출, 모든 행동 감사 가능.',
    'features.multiterminal.title': '멀티 터미널 접근',
    'features.multiterminal.desc': '하나의 계정, 6개의 입구: 모바일 앱, NFC 카드, POS 터미널, 음성 비서, 키오스크, 로봇 API. 각각 신뢰 등급과 터미널 클래스 정책 적용. NFC/EMV, POS 장치, 음성 I/O 하드웨어 어댑터 지원. 지갑은 앱이 아닌 정책 바인딩 계정.',
    'features.confidentialdefi.title': '기밀 DeFi',
    'features.confidentialdefi.desc': '22+ 동형 암호문 연산, 모두 실제 ZK 검증 완료. 암호화 대출, 프라이빗 에스크로, 기밀 경매——모두 온체인. UNO 타입이 2슬롯 암호화 스토리지, 메서드 구문, 증명 번들을 스마트 계약에 제공. 패를 보여주지 않는 DeFi.',
    'features.agentmail.title': 'P2P 에이전트 메일',
    'features.agentmail.desc': '에이전트 간 엔드투엔드 암호화 메시징. SECP256K1-AES256GCM 암호화, TNS 이름 해석, NAT 트래버설용 게이트웨이 릴레이. 리플레이 방지, 스레딩, 폴더 관리. 중개자 없이 에이전트 간 비밀 협업.',
    'features.auditreceipt.title': '감사 영수증 시스템',
    'features.auditreceipt.desc': '모든 금융 행동이 검증 가능한 흔적을 남김. 온체인 감사 영수증에 증명 참조, 정책 결정 기록, 스폰서 귀속, 정산 추적 포함. 추가 전용 저널로 분쟁 해결과 규제 검사에 대응.',
    'features.gatewayrelay.title': '게이트웨이 릴레이',
    'features.gatewayrelay.desc': '에이전트를 위한 퍼스트클래스 NAT 트래버설. 프로바이더 에이전트가 릴레이 기능을 광고하고, 퍼블릭 URL을 할당하며, 아웃바운드 WebSocket 세션을 유지. 방화벽 뒤의 에이전트도 게이트웨이 네트워크를 통해 서비스 제공 가능.',
    'features.settlement.title': '비동기 정산',
    'features.settlement.desc': '정산 콜백과 비동기 이행을 체인 프리미티브로 제공. 콜백 등록, 조건 실행, 비동기 요청 이행. 정책 지갑과 감사 영수증과 결합 가능하여 엔드투엔드 정산 추적 경로 실현.',
    'features.bounty.title': '바운티 & 작업 마켓플레이스',
    'features.bounty.desc': '에이전트가 작업 완료로 수익: 질문 답변, 번역, 소셜 증명, 문제 해결. 캠페인 예산, 자동 매칭, 증명 인식 검증, 지급 쿨다운. AI 에이전트가 품질과 속도로 경쟁하는 탈중앙화 노동 시장.',
    'features.fleet.title': '플릿 관리',
    'features.fleet.desc': '멀티 노드 에이전트 운영과 운영자 대시보드. 헬스 모니터링, 큐 복구, 승인 게이팅 오토파일럿. 인시던트 스냅샷, 알림 전달, 자동 복구. 단일 컨트롤 플레인에서 수익 창출 에이전트 플릿을 관리.',
    'features.templates.title': '10개 표준 계약 템플릿',
    'features.templates.desc': '프로덕션 레디 TOL 템플릿: PolicyWallet, SpendGuard, GuardianRecovery, TerminalAuthority, DelegatedAgent(정책용); TaskEscrow, OracleResolver, RecurringPayment, SponsorRelay, MerchantPayment(에이전트 경제용). 몇 분 만에 배포.',
    'features.paidservices.title': '유료 에이전트 서비스',
    'features.paidservices.desc': '에이전트가 역량을 수익화: 유료 관측, 오라클 해결, 증명 검증, 뉴스 캡처, 스토리지 호스팅. x402 결제 프로토콜과 영구 서버 사이드 원장. 스폰서 발견, 다중 요소 라우트 스코어링, 수익 추적 내장.',
    'features.ownerreports.title': '소유자 보고서 & 승인',
    'features.ownerreports.desc': '일일 및 주간 재무 보고서를 웹 또는 이메일로 전달. 트레저리와 프로바이더 정책 결정을 위한 소유자 승인 인박스. 기회 알림과 액션 큐. 감사 준비 내보내기가 포함된 완전한 실행 이력.',
    'features.communication.title': '에이전트 통신 레이어',
    'features.communication.desc': 'OpenFox 같은 실제 제품을 떠받치는 통신 레이어입니다. 직접 메시지, 암호화된 그룹 스레드, 인박스 워크플로, 그리고 소유자 대상 Web/Email 전달까지 모두 에이전트의 1급 프리미티브가 됩니다. 이름 기반 라우팅, 릴레이 친화적 전달, 엔드투엔드 암호화로 에이전트 통신을 데모용 채팅 이상으로 끌어올립니다.',
...
const homepageOverrides = {
  en: {
    ...
    'nav.buildOnTOS': 'Uno Workchain',
    'nav.learnMore': 'Technical Reading',
    'nav.resources': 'Repository',
    'nav.devTools': 'EVM Workchain',
    'nav.documentation': 'Doc Index',
    'nav.whitepaper': 'Whitepaper',
    'hero.title': 'One Masterchain.<br><span class="highlight">Three Execution Domains.</span>',
    'hero.getTOS': 'Read Overview',
    'hero.startMining': 'EVM Workchain',
    'features.subtitle': 'Native TVM, Ethereum-compatible EVM, and UNO PQ-native privacy run in parallel under one masterchain-rooted consensus. One validator-engine, one tosctl, one cell-native state model.',
    'features.did.title': 'Native Layer (wc=0)',
    'features.did.desc': 'Asynchronous, sharded TVM execution for message-driven apps. This is the high-throughput native layer for TOS contracts, batch fan-out, and core protocol primitives.',
    'features.agiw.title': 'EVM Workchain (wc=1)',
    'features.agiw.desc': 'A synchronous Ethereum-semantic execution domain. Deploy unmodified Solidity contracts and talk to it through standard Ethereum JSON-RPC served directly by validator-engine.',
    'features.credits.title': 'Uno Privacy (wc=2)',
    'features.credits.desc': 'A PQ-native privacy workchain: shielded note-pool transfers, Plonky3 STARK proofs, Poseidon2, and hybrid ECDH + ML-KEM-768 note encryption. Bridgeless by architecture.',
    'features.performance.title': 'One validator-engine',
    'features.performance.desc': 'One node binary serves all three workchains. Public APIs, validation, liteserver duties, and workchain dispatch all anchor back to the same root of truth.',
    'features.trilemma.title': 'One canonical CLI',
    'features.trilemma.desc': 'tosctl is the operator and wallet entry point for the network: node operation, wallet flows, and workchain-specific tooling live on a single path instead of fragmented sidecars.',
    'features.instant.title': 'Unified JSON-RPC',
    'features.instant.desc': 'TOS-native tos_* methods, standard eth_* on wc=1, and uno_* on wc=2 are all surfaced from the node. One RPC surface, three execution domains.',
    'features.pruning.title': 'Cell-native state',
    'features.pruning.desc': 'TVM cells, EVM account state, and Uno shielded state all commit into TOS cells. The storage layer stays uniform even as execution models differ.',
    'features.spv.title': 'Deterministic execution',
    'features.spv.desc': 'Consensus-critical paths avoid wall-clock reads, OS RNG, and nondeterministic map iteration. The repo treats determinism as a protocol invariant, not SDK hygiene.',
    'features.fairlaunch.title': 'Shared masterchain consensus',
    'features.fairlaunch.desc': 'wc=0, wc=1, and wc=2 are first-class workchains under one masterchain-rooted consensus. Users choose the execution domain per transaction; validators opt in per workchain.',
    'features.deflationary.title': 'Native ↔ EVM value flow',
    'features.deflationary.desc': 'Cross-workchain value transfer between the native layer and wc=1 uses the TOS message model. Uno stays isolated on purpose: no shield, no unshield, no bridge.',
    'features.takovm.title': 'Catchain foundation',
    'features.takovm.desc': 'Block production is rooted in Catchain, with ongoing convergence toward a Simplex-oriented design for cleaner proof-of-progress and validator behavior.',
    'features.community.title': 'Ethereum toolchain compatible',
    'features.community.desc': 'MetaMask, ethers.js, web3.py, Foundry, Hardhat, and Remix connect to wc=1 without adapters. Existing Solidity codebases deploy as-is.',
    'features.zkprivacy.title': 'PQ-native privacy posture',
    'features.zkprivacy.desc': 'Uno ships with hash-based STARK proving and hybrid PQ note encryption from day one, reducing the migration debt that pairing-based privacy systems still carry.',
    'features.cryptography.title': 'Plonky3 + ML-KEM',
    'features.cryptography.desc': 'Uno combines Plonky3 STARKs over Goldilocks with Poseidon2 and ML-KEM-768 hybrid note encryption. Wallets prove locally; validators verify deterministically.',
    'features.parallel.title': 'Validator + liteserver ops',
    'features.parallel.desc': 'The repo already carries validator-engine, liteserver, proxy-liteserver, and related operator tooling. TOS is built around a real node stack, not just contract deployment UX.',
    'features.security.title': 'Source-first technical docs',
    'features.security.desc': 'README, BUILD.md, EVM topology docs, Uno design docs, Catchain papers, and changelogs in the repo are the fastest way to understand what is real, shipped, and in flight.',
    'features.encrypted.title': 'ADNL / DHT / RLDP / QUIC',
    'features.encrypted.desc': 'TOS includes its own network stack: ADNL identities, DHT discovery, RLDP transport, QUIC interop tests, and validator overlays for the node-to-node path.',
    'features.communication.title': 'Sites, DNS, Connect',
    'features.communication.desc': 'Beyond raw chain execution, the codebase already includes TOS Connect wallet flows, TOS DNS name resolution, and TOS Sites style decentralized serving primitives.',
    'features.coreTitle': 'One Masterchain, Three Execution Domains',
    'features.coreSubtitle': 'Different workloads want different trade-offs. TOS runs a native sharded TVM layer, an Ethereum-compatible EVM workchain, and UNO privacy in parallel instead of forcing everything into one VM.',
    'performance.title': 'Grounded Technical Snapshot',
    'performance.subtitle': 'A few facts that stand out in the current codebase.',
    'stats.workchains.label': 'Workchains',
    'stats.workchains.desc': 'wc=0 TVM, wc=1 EVM, wc=2 Uno',
    'stats.node.label': 'Node Binary',
    'stats.node.desc': 'validator-engine serves the stack',
    'stats.cli.label': 'Canonical CLI',
    'stats.cli.desc': 'tosctl for ops and wallet flows',
    'stats.cadence.label': 'Global Cadence',
    'stats.cadence.desc': 'Shared block rhythm across TOS',
    'stats.rpc.label': 'JSON-RPC',
    'stats.rpc.desc': 'Standard Ethereum methods on wc=1',
    'stats.bridges.label': 'Uno Bridges',
    'stats.bridges.desc': 'No shield, no unshield, no bridge',
    'stats.state.label': 'State Model',
    'stats.state.desc': 'TVM, EVM, and Uno share cells',
    'stats.network.label': 'Network Stack',
    'stats.network.desc': 'ADNL, DHT, RLDP, and QUIC',
    'docs.title': 'Technical Entry Points',
    'docs.desc': 'Start with the source-of-truth docs in the repository.',
    'docs.smartContracts': 'Repository Overview',
    'docs.aiMining': 'EVM Workchain',
    'docs.exploreAll': 'Uno Workchain',
    'whitepaper.title': 'Whitepaper & References',
    'whitepaper.desc': 'Read the latest TOS whitepaper, consensus paper, and low-level technical references bundled from the main repository.',
    ...
    'faq.title': 'Frequently Asked Questions',
    'faq.q1': 'What is TOS Network?',
    'faq.a1': 'TOS is a multichain Layer-1 with one masterchain-rooted consensus and three execution domains: asynchronous native TVM on wc=0, Ethereum-compatible EVM on wc=1, and PQ-native Uno privacy on wc=2. One validator-engine, one tosctl path, and one cell-native state model tie the stack together.',
    'faq.q2': 'What are the advantages of TOS Network?',
    'faq.a2.h1': 'Native Layer (wc=0)',
    'faq.a2.p1': 'Asynchronous, sharded TVM execution gives TOS a message-driven base layer for high-throughput contracts, actor-style apps, and protocol-native primitives.',
    'faq.a2.h2': 'EVM Workchain (wc=1)',
    'faq.a2.p2': 'wc=1 preserves Ethereum semantics and standard JSON-RPC, so Solidity contracts, MetaMask, ethers.js, Foundry, Hardhat, and Remix can work without adapters.',
    'faq.a2.h3': 'Uno Privacy (wc=2)',
    'faq.a2.p3': 'Uno is a bridgeless shielded note-pool workchain built around Plonky3 STARKs, Poseidon2, and hybrid ECDH + ML-KEM-768 note encryption.',
    'faq.a2.h4': 'One Node, One CLI, One RPC Surface',
    'faq.a2.p4': 'validator-engine serves the public APIs and validation path, while tosctl stays the canonical operator and wallet entry point across the stack.',
    'faq.a2.h5': 'Cell-Native and Deterministic',
    'faq.a2.p5': 'TVM, EVM, and Uno commit into the same cell-based storage model, and consensus-critical execution avoids wall-clock time, OS RNG, and nondeterministic iteration.',
    'faq.q3': 'How compatible is the EVM workchain?',
    'faq.a3': 'wc=1 is designed to feel like Ethereum instead of an EVM-shaped wrapper. The node serves standard eth_* JSON-RPC directly, and the repo positions MetaMask, ethers.js, web3.py, Foundry, Hardhat, and Remix as first-class tooling.',
    'faq.q4': 'What makes Uno different from bridge-based privacy?',
    'faq.a4': 'Uno is not a mixer bolted onto a public asset. It is a separate native privacy workchain whose supply is born shielded at genesis, with no shield, no unshield, and no bridge to other workchains as a permanent architectural rule.',
    'faq.q5': 'What do operators actually run?',
    'faq.a5': 'The codebase is built around validator-engine plus the surrounding node stack, with tosctl as the canonical CLI. BUILD.md also documents liteserver, proxy-liteserver, Rust-side tooling, and the extra prerequisites needed to build Uno end to end.',
    'faq.q6': 'What product primitives already exist beyond the chain core?',
    'faq.a6': 'The repository already includes TOS Connect wallet-to-dApp flows, TOS DNS name resolution, TOS Sites style decentralized serving, and the ADNL / DHT / RLDP / QUIC networking stack that supports node and product connectivity.',
    'faq.q7': 'What makes TOS different from single-VM chains?',
    'faq.a7': 'TOS does not force every workload into one execution model. Native TVM, EVM, and Uno privacy stay separate where their invariants differ, but they still share one masterchain-rooted consensus, one operator path, and one state substrate.',
    'faq.bottomText': 'Questions, corrections, or missing features? The repo is the source of truth.',
    'footer.getStarted': 'Start Here',
    'footer.getTOS': 'Read Overview',
    'footer.startMining': 'Build from Source',
    'footer.buildOnTOS': 'Uno Workchain',
    'footer.learnMore': 'Technical Reading',
    'footer.resources': 'Repository',
    'footer.devTools': 'EVM Workchain',
  ...
  zh: {
    ...
    'nav.buildOnTOS': 'Uno 工作链',
    'nav.learnMore': '技术资料',
    'nav.resources': '代码仓库',
    'nav.devTools': 'EVM 工作链',
    'nav.documentation': '文档索引',
    'nav.whitepaper': '白皮书',
    'hero.title': '一条主链。<br><span class="highlight">三种执行域。</span>',
    'hero.getTOS': '阅读概览',
    'hero.startMining': 'EVM 工作链',
    'features.subtitle': '原生 TVM、兼容以太坊的 EVM，以及 UNO 后量子原生隐私并行运行在同一套 masterchain 共识之下。一个 validator-engine，一个 tosctl，一套 cell-native 状态模型。',
    'features.did.title': '原生层 (wc=0)',
    'features.did.desc': '面向消息驱动应用的异步分片 TVM 执行层，是 TOS 合约、批量扇出和协议原语的高吞吐基础层。',
    'features.agiw.title': 'EVM 工作链 (wc=1)',
    'features.agiw.desc': '一个保持以太坊语义的同步执行域。可直接部署未修改的 Solidity 合约，并通过 validator-engine 提供的标准 Ethereum JSON-RPC 访问。',
    'features.credits.title': 'Uno 隐私 (wc=2)',
    'features.credits.desc': '后量子原生隐私工作链：屏蔽 note-pool 转账、Plonky3 STARK 证明、Poseidon2，以及 ECDH + ML-KEM-768 混合票据加密。架构上天然无桥。',
    'features.performance.title': '一个 validator-engine',
    'features.performance.desc': '一个节点二进制服务三条工作链。公共 API、验证、liteserver 职责和工作链分发都锚定在同一套真相根上。',
    'features.trilemma.title': '一个标准 CLI',
    'features.trilemma.desc': 'tosctl 是网络的运维与钱包入口：节点操作、钱包流程和工作链工具统一走一条路径，而不是分散在多个 sidecar 中。',
    'features.instant.title': '统一 JSON-RPC',
    'features.instant.desc': '节点同时暴露 TOS 原生的 tos_*、wc=1 上标准的 eth_*，以及 wc=2 上的 uno_*。一个 RPC 面，三种执行域。',
    'features.pruning.title': 'Cell 原生状态',
    'features.pruning.desc': 'TVM cells、EVM 账户状态和 Uno 屏蔽状态都提交进 TOS cells。即使执行模型不同，底层存储仍保持统一。',
    'features.spv.title': '确定性执行',
    'features.spv.desc': '共识关键路径避免使用墙上时钟、操作系统随机数和不确定的 map 遍历。代码库把确定性视为协议不变量，而不是 SDK 层习惯。',
    'features.fairlaunch.title': '共享 masterchain 共识',
    'features.fairlaunch.desc': 'wc=0、wc=1、wc=2 都是一等工作链，挂在同一个 masterchain 共识之下。用户按交易选择执行域，验证者按工作链选择加入。',
    'features.deflationary.title': '原生 ↔ EVM 价值流转',
    'features.deflationary.desc': '原生层与 wc=1 之间的跨工作链价值转移使用 TOS 消息模型。Uno 则刻意隔离：没有 shield、没有 unshield、没有 bridge。',
    'features.takovm.title': 'Catchain 基础',
    'features.takovm.desc': '出块建立在 Catchain 之上，并持续向更偏 Simplex 的设计收敛，以获得更清晰的进度证明和验证者行为模型。',
    'features.community.title': '兼容以太坊工具链',
    'features.community.desc': 'MetaMask、ethers.js、web3.py、Foundry、Hardhat、Remix 都可直接连接 wc=1，无需适配器。现有 Solidity 代码库可以原样部署。',
    'features.zkprivacy.title': '后量子原生隐私姿态',
    'features.zkprivacy.desc': 'Uno 从第一天起就采用基于哈希的 STARK 证明和混合后量子票据加密，减少了配对型隐私系统仍背负的迁移债务。',
    'features.cryptography.title': 'Plonky3 + ML-KEM',
    'features.cryptography.desc': 'Uno 将 Goldilocks 域上的 Plonky3 STARK、Poseidon2 和 ML-KEM-768 混合票据加密组合在一起。钱包本地出证明，验证者确定性验证。',
    'features.parallel.title': '验证者 + liteserver 运维',
    'features.parallel.desc': '仓库已经包含 validator-engine、liteserver、proxy-liteserver 及相关运维工具。TOS 面向真实节点栈，而不只是合约部署体验。',
    'features.security.title': '源码优先的技术文档',
    'features.security.desc': 'README、BUILD.md、EVM 拓扑文档、Uno 设计文档、Catchain 论文和变更日志，是理解哪些内容真实存在、已经落地或正在推进的最快入口。',
    'features.encrypted.title': 'ADNL / DHT / RLDP / QUIC',
    'features.encrypted.desc': 'TOS 拥有自己的网络栈：ADNL 身份、DHT 发现、RLDP 传输、QUIC 互操作测试，以及节点间路径上的验证者 overlay。',
    'features.communication.title': 'Sites、DNS、Connect',
    'features.communication.desc': '除了链执行本身，代码库还包含 TOS Connect 钱包连接流程、TOS DNS 名称解析，以及 TOS Sites 风格的去中心化内容服务原语。',
    'features.coreTitle': '一条主链，三种执行域',
    'features.coreSubtitle': '不同负载需要不同权衡。TOS 并行运行原生分片 TVM、兼容以太坊的 EVM 工作链和 UNO 隐私，而不是把一切都塞进同一个 VM。',
    'performance.title': '基于代码库的技术快照',
    'performance.subtitle': '当前仓库里最值得先看的几个事实。',
    'stats.workchains.label': '工作链',
    'stats.workchains.desc': 'wc=0 TVM，wc=1 EVM，wc=2 Uno',
    'stats.node.label': '节点二进制',
    'stats.node.desc': 'validator-engine 承载整套栈',
    'stats.cli.label': '标准 CLI',
    'stats.cli.desc': 'tosctl 负责运维和钱包流程',
    'stats.cadence.label': '全局节奏',
    'stats.cadence.desc': 'TOS 共享约 1 秒出块节奏',
    'stats.rpc.label': 'JSON-RPC',
    'stats.rpc.desc': 'wc=1 直接提供标准以太坊方法',
    'stats.bridges.label': 'Uno 桥接',
    'stats.bridges.desc': '没有 shield、unshield 或桥',
    'stats.state.label': '状态模型',
    'stats.state.desc': 'TVM、EVM、Uno 共享 cells',
    'stats.network.label': '网络栈',
    'stats.network.desc': 'ADNL、DHT、RLDP 与 QUIC',
    'docs.title': '技术入口',
    'docs.desc': '先从仓库里的权威文档开始。',
    'docs.smartContracts': '仓库概览',
    'docs.aiMining': 'EVM 工作链',
    'docs.exploreAll': 'Uno 工作链',
    'whitepaper.title': '白皮书与技术参考',
    'whitepaper.desc': '这里汇集了主仓库同步过来的最新版 TOS 白皮书、共识论文和底层技术参考文档。',
    ...
    'faq.title': '常见问题',
    'faq.q1': '什么是 TOS 网络？',
    'faq.a1': 'TOS 是一条多链 Layer-1：在同一套 masterchain 共识之下，提供 wc=0 上的异步原生 TVM、wc=1 上兼容以太坊的 EVM，以及 wc=2 上后量子原生的 Uno 隐私。整个系统由一个 validator-engine、一条 tosctl 路径和一套 cell-native 状态模型串起来。',
    'faq.q2': 'TOS 网络有哪些优势？',
    'faq.a2.h1': '原生层 (wc=0)',
    'faq.a2.p1': '异步、分片的 TVM 执行为 TOS 提供了消息驱动的基础层，适合高吞吐合约、actor 风格应用和协议原语。',
    'faq.a2.h2': 'EVM 工作链 (wc=1)',
    'faq.a2.p2': 'wc=1 保持以太坊语义和标准 JSON-RPC，因此 Solidity 合约、MetaMask、ethers.js、Foundry、Hardhat、Remix 都可直接使用。',
    'faq.a2.h3': 'Uno 隐私 (wc=2)',
    'faq.a2.p3': 'Uno 是一个无桥的屏蔽 note-pool 工作链，围绕 Plonky3 STARK、Poseidon2 和 ECDH + ML-KEM-768 混合票据加密构建。',
    'faq.a2.h4': '一个节点，一个 CLI，一个 RPC 面',
    'faq.a2.p4': 'validator-engine 提供公共 API 和验证路径，tosctl 则保持整个栈的标准运维与钱包入口。',
    'faq.a2.h5': 'Cell 原生且确定性',
    'faq.a2.p5': 'TVM、EVM 和 Uno 都提交到同一套基于 cell 的状态模型中，且共识关键执行避免墙上时钟、系统随机数和不确定遍历。',
    'faq.q3': 'EVM 工作链兼容性如何？',
    'faq.a3': 'wc=1 的目标是像以太坊，而不是一个“长得像 EVM”的包装层。节点直接提供标准 eth_* JSON-RPC，仓库也明确把 MetaMask、ethers.js、web3.py、Foundry、Hardhat 和 Remix 当作一等工具链。',
    'faq.q4': 'Uno 和桥接式隐私有什么区别？',
    'faq.a4': 'Uno 不是附着在公开资产上的 mixer，而是一条独立的原生隐私工作链。它的供应在创世时即为屏蔽状态，并以永久架构规则禁止 shield、unshield 和与其他工作链之间的 bridge。',
    'faq.q5': '运维者实际要跑什么？',
    'faq.a5': '代码库围绕 validator-engine 和周边节点栈构建，tosctl 是标准 CLI。BUILD.md 还覆盖了 liteserver、proxy-liteserver、Rust 侧工具链，以及构建 Uno 所需的额外依赖。',
    'faq.q6': '除了链核心之外，已经有哪些产品原语？',
    'faq.a6': '仓库里已经有 TOS Connect 钱包到 dApp 的连接流程、TOS DNS 名称解析、TOS Sites 风格的去中心化内容服务，以及支撑节点和产品互联的 ADNL / DHT / RLDP / QUIC 网络栈。',
    'faq.q7': 'TOS 和单 VM 链的区别是什么？',
    'faq.a7': 'TOS 不会把所有负载强行塞进同一个执行模型。原生 TVM、EVM 和 Uno 隐私在各自不变量不同的地方保持分离，但仍共享同一套 masterchain 共识、同一条运维路径和同一底层状态基底。',
    'faq.bottomText': '如果你发现问题、缺项或需要更正，以仓库为准。',
    'footer.getStarted': '开始了解',
    'footer.getTOS': '阅读概览',
    'footer.startMining': '源码构建',
    'footer.buildOnTOS': 'Uno 工作链',
    'footer.learnMore': '技术资料',
    'footer.resources': '代码仓库',
    'footer.devTools': 'EVM 工作链',
  ...
  ja: {
    ...
    'nav.buildOnTOS': 'Unoワークチェーン',
    'nav.learnMore': '技術資料',
    'nav.resources': 'リポジトリ',
    'nav.devTools': 'EVMワークチェーン',
    'nav.documentation': 'ドキュメント索引',
    'nav.whitepaper': 'ホワイトペーパー',
    'hero.title': '1つのマスターチェーン。<br><span class="highlight">3つの実行ドメイン。</span>',
    'hero.getTOS': '概要を読む',
    'hero.startMining': 'EVMワークチェーン',
    'features.subtitle': 'ネイティブTVM、Ethereum互換EVM、そしてUNOのPQネイティブなプライバシーが、1つのmasterchainルートのコンセンサスの上で並行して動きます。1つのvalidator-engine、1つのtosctl、1つのcell-native状態モデルです。',
    'features.did.title': 'ネイティブレイヤー (wc=0)',
    'features.did.desc': 'メッセージ駆動アプリ向けの非同期・シャード化TVM実行レイヤーです。TOSコントラクト、バッチ配信、プロトコル原語の高スループット基盤になります。',
    'features.agiw.title': 'EVMワークチェーン (wc=1)',
    'features.agiw.desc': 'Ethereumの意味論を保つ同期実行ドメインです。未変更のSolidityコントラクトをそのままデプロイでき、validator-engineが提供する標準Ethereum JSON-RPCから利用できます。',
    'features.credits.title': 'Unoプライバシー (wc=2)',
    'features.credits.desc': 'PQネイティブなプライバシーワークチェーンです。シールドされたnote-pool送金、Plonky3 STARK、Poseidon2、そしてECDH + ML-KEM-768のハイブリッド暗号化を採用し、設計上ブリッジを持ちません。',
    'features.performance.title': '1つのvalidator-engine',
    'features.performance.desc': '1つのノードバイナリが3つのワークチェーンをまとめて支えます。公開API、検証、liteserverの役割、ワークチェーンの振り分けが同じ真実の根に集約されます。',
    'features.trilemma.title': '1つの標準CLI',
    'features.trilemma.desc': 'tosctlはネットワークの運用とウォレットの入口です。ノード運用、ウォレット操作、ワークチェーン別のツールを、分裂したsidecarではなく1つの経路にまとめます。',
    'features.instant.title': '統一JSON-RPC',
    'features.instant.desc': 'ノードはTOSネイティブのtos_*、wc=1の標準eth_*、wc=2のuno_*をまとめて公開します。1つのRPC面で3つの実行ドメインを扱えます。',
    'features.pruning.title': 'Cellネイティブ状態',
    'features.pruning.desc': 'TVMのcells、EVMのアカウント状態、Unoのシールド状態はすべてTOS cellsにコミットされます。実行モデルが異なっても保存層は統一されたままです。',
    'features.spv.title': '決定論的実行',
    'features.spv.desc': 'コンセンサスクリティカルな経路では壁時計、OS乱数、非決定的なmap反復を避けます。リポジトリは決定論をSDKの作法ではなくプロトコル不変条件として扱います。',
    'features.fairlaunch.title': '共有masterchainコンセンサス',
    'features.fairlaunch.desc': 'wc=0、wc=1、wc=2は1つのmasterchainルートのコンセンサス配下にある第一級ワークチェーンです。ユーザーは取引ごとに実行ドメインを選び、バリデータはワークチェーンごとに参加します。',
    'features.deflationary.title': 'ネイティブ ↔ EVM価値移動',
    'features.deflationary.desc': 'ネイティブ層とwc=1の間の価値移動はTOSのメッセージモデルで行われます。Unoは意図的に隔離され、shieldもunshieldもbridgeもありません。',
    'features.takovm.title': 'Catchain基盤',
    'features.takovm.desc': 'ブロック生成はCatchainに根を持ち、より明快な進捗証明とバリデータ挙動のためにSimplex寄りの設計へ収束を続けています。',
    'features.community.title': 'Ethereumツールチェーン互換',
    'features.community.desc': 'MetaMask、ethers.js、web3.py、Foundry、Hardhat、Remixがwc=1へそのまま接続できます。既存のSolidityコードベースも変更なしでデプロイできます。',
    'features.zkprivacy.title': 'PQネイティブなプライバシー姿勢',
    'features.zkprivacy.desc': 'Unoは初日からハッシュベースのSTARK証明とハイブリッドPQ暗号化を採用し、ペアリング系プライバシーが抱える移行負債を減らします。',
    'features.cryptography.title': 'Plonky3 + ML-KEM',
    'features.cryptography.desc': 'UnoはGoldilocks上のPlonky3 STARK、Poseidon2、ML-KEM-768ハイブリッド暗号化を組み合わせます。ウォレットがローカルで証明し、バリデータが決定論的に検証します。',
    'features.parallel.title': 'バリデータ + liteserver運用',
    'features.parallel.desc': 'リポジトリにはvalidator-engine、liteserver、proxy-liteserver、関連する運用ツールがすでに含まれています。TOSは単なるコントラクト配備UXではなく、実ノードスタックを前提にしています。',
    'features.security.title': 'ソース優先の技術文書',
    'features.security.desc': 'README、BUILD.md、EVMトポロジ文書、Uno設計文書、Catchain論文、変更履歴は、何が実装済みで何が進行中かを最短で把握する入口です。',
    'features.encrypted.title': 'ADNL / DHT / RLDP / QUIC',
    'features.encrypted.desc': 'TOSは独自のネットワークスタックを持ちます。ADNLアイデンティティ、DHT探索、RLDP転送、QUIC相互運用テスト、バリデータoverlaysがノード間通信を支えます。',
    'features.communication.title': 'Sites、DNS、Connect',
    'features.communication.desc': 'チェーン実行だけでなく、コードベースにはTOS Connectのウォレット接続、TOS DNSの名前解決、TOS Sites型の分散配信原語も含まれています。',
    'features.coreTitle': '1つのマスターチェーン、3つの実行ドメイン',
    'features.coreSubtitle': '必要な負荷特性は1つではありません。TOSはネイティブのシャードTVM、Ethereum互換EVM、UNOプライバシーを並列に走らせ、すべてを1つのVMに押し込みません。',
    'performance.title': 'コードベースから見る技術スナップショット',
    'performance.subtitle': '現在のリポジトリで特に重要な事実をいくつか挙げます。',
    'stats.workchains.label': 'ワークチェーン',
    'stats.workchains.desc': 'wc=0 TVM、wc=1 EVM、wc=2 Uno',
    'stats.node.label': 'ノードバイナリ',
    'stats.node.desc': 'validator-engineが全体を支える',
    'stats.cli.label': '標準CLI',
    'stats.cli.desc': 'tosctlが運用とウォレットを担当',
    'stats.cadence.label': 'グローバル周期',
    'stats.cadence.desc': 'TOS全体で約1秒のブロック周期',
    'stats.rpc.label': 'JSON-RPC',
    'stats.rpc.desc': 'wc=1で標準Ethereumメソッドを提供',
    'stats.bridges.label': 'Unoブリッジ',
    'stats.bridges.desc': 'shieldもunshieldもbridgeもなし',
    'stats.state.label': '状態モデル',
    'stats.state.desc': 'TVM、EVM、Unoがcellsを共有',
    'stats.network.label': 'ネットワークスタック',
    'stats.network.desc': 'ADNL、DHT、RLDP、QUIC',
    'docs.title': '技術的な入口',
    'docs.desc': 'まずはリポジトリ内の一次情報から始めてください。',
    'docs.smartContracts': 'リポジトリ概要',
    'docs.aiMining': 'EVMワークチェーン',
    'docs.exploreAll': 'Unoワークチェーン',
    'whitepaper.title': 'ホワイトペーパーと技術資料',
    'whitepaper.desc': 'メインリポジトリから同期した最新のTOSホワイトペーパー、コンセンサス文書、低レベル技術資料を読めます。',
    ...
    'faq.title': 'よくある質問',
    'faq.q1': 'TOSネットワークとは何ですか？',
    'faq.a1': 'TOSはマルチチェーンLayer-1です。1つのmasterchainルートのコンセンサスの下で、wc=0の非同期ネイティブTVM、wc=1のEthereum互換EVM、wc=2のPQネイティブなUnoプライバシーを提供します。1つのvalidator-engine、1つのtosctl経路、1つのcell-native状態モデルが全体をつなぎます。',
    'faq.q2': 'TOSネットワークの利点は何ですか？',
    'faq.a2.h1': 'ネイティブレイヤー (wc=0)',
    'faq.a2.p1': '非同期でシャード化されたTVM実行により、高スループット契約、actor型アプリ、プロトコル原語向けのメッセージ駆動ベースレイヤーを提供します。',
    'faq.a2.h2': 'EVMワークチェーン (wc=1)',
    'faq.a2.p2': 'wc=1はEthereumの意味論と標準JSON-RPCを保つため、Solidity、MetaMask、ethers.js、Foundry、Hardhat、Remixをそのまま使えます。',
    'faq.a2.h3': 'Unoプライバシー (wc=2)',
    'faq.a2.p3': 'UnoはPlonky3 STARK、Poseidon2、ECDH + ML-KEM-768ハイブリッド暗号化で構成された、ブリッジなしのシールドnote-poolワークチェーンです。',
    'faq.a2.h4': '1つのノード、1つのCLI、1つのRPC面',
    'faq.a2.p4': 'validator-engineが公開APIと検証経路を担当し、tosctlが全スタックの標準的な運用・ウォレット入口を担います。',
    'faq.a2.h5': 'Cellネイティブで決定論的',
    'faq.a2.p5': 'TVM、EVM、Unoは同じcellベース状態モデルへコミットし、コンセンサス重要経路では壁時計、OS乱数、非決定的反復を避けます。',
    'faq.q3': 'EVMワークチェーンの互換性はどの程度ですか？',
    'faq.a3': 'wc=1はEVM風のラッパーではなく、Ethereumとして感じられることを目指しています。ノードが標準eth_* JSON-RPCを直接提供し、MetaMask、ethers.js、web3.py、Foundry、Hardhat、Remixを第一級ツールとして位置付けています。',
    'faq.q4': 'Unoはブリッジ型プライバシーと何が違いますか？',
    'faq.a4': 'Unoは公開資産の上に後付けされたミキサーではありません。創世時から供給全体がシールドされた独立ネイティブプライバシーワークチェーンであり、shield、unshield、他ワークチェーンとのbridgeを恒久的な設計ルールとして禁止しています。',
    'faq.q5': '運用者は実際に何を動かしますか？',
    'faq.a5': 'コードベースはvalidator-engineと周辺ノードスタックを中心に組まれており、tosctlが標準CLIです。BUILD.mdにはliteserver、proxy-liteserver、Rust側ツール群、Unoを含む完全ビルドの前提条件も整理されています。',
    'faq.q6': 'チェーン本体以外に、どんなプロダクト原語がありますか？',
    'faq.a6': 'リポジトリにはTOS Connectのウォレット接続、TOS DNSの名前解決、TOS Sites型の分散配信、そしてノードとプロダクト接続を支えるADNL / DHT / RLDP / QUICスタックがすでに含まれています。',
    'faq.q7': 'TOSは単一VMチェーンと何が違いますか？',
    'faq.a7': 'TOSはすべての負荷を1つの実行モデルに押し込みません。ネイティブTVM、EVM、Unoプライバシーは不変条件が異なる部分で分離しつつ、同じmasterchainルートのコンセンサス、同じ運用経路、同じ状態基盤を共有します。',
    'faq.bottomText': '修正点や不足があれば、リポジトリを一次情報として確認してください。',
    'footer.getStarted': 'はじめに',
    'footer.getTOS': '概要を読む',
    'footer.startMining': 'ソースからビルド',
    'footer.buildOnTOS': 'Unoワークチェーン',
    'footer.learnMore': '技術資料',
    'footer.resources': 'リポジトリ',
    'footer.devTools': 'EVMワークチェーン',
  ...
  ko: {
    ...
    'nav.buildOnTOS': 'Uno 워크체인',
    'nav.learnMore': '기술 자료',
    'nav.resources': '리포지토리',
    'nav.devTools': 'EVM 워크체인',
    'nav.documentation': '문서 색인',
    'nav.whitepaper': '백서',
    'hero.title': '하나의 마스터체인.<br><span class="highlight">세 가지 실행 도메인.</span>',
    'hero.getTOS': '개요 읽기',
    'hero.startMining': 'EVM 워크체인',
    'features.subtitle': '네이티브 TVM, 이더리움 호환 EVM, 그리고 UNO의 PQ 네이티브 프라이버시가 하나의 masterchain 루트 합의 아래 병렬로 동작합니다. 하나의 validator-engine, 하나의 tosctl, 하나의 cell-native 상태 모델입니다.',
    'features.did.title': '네이티브 레이어 (wc=0)',
    'features.did.desc': '메시지 기반 앱을 위한 비동기 샤딩 TVM 실행 레이어입니다. TOS 컨트랙트, 배치 팬아웃, 프로토콜 프리미티브를 위한 고처리량 기반층입니다.',
    'features.agiw.title': 'EVM 워크체인 (wc=1)',
    'features.agiw.desc': '이더리움 의미론을 유지하는 동기 실행 도메인입니다. 수정하지 않은 Solidity 컨트랙트를 그대로 배포하고 validator-engine이 제공하는 표준 Ethereum JSON-RPC로 접근할 수 있습니다.',
    'features.credits.title': 'Uno 프라이버시 (wc=2)',
    'features.credits.desc': 'PQ 네이티브 프라이버시 워크체인입니다. 실드된 note-pool 전송, Plonky3 STARK, Poseidon2, 그리고 ECDH + ML-KEM-768 하이브리드 노트 암호화를 사용하며 설계상 브리지가 없습니다.',
    'features.performance.title': '하나의 validator-engine',
    'features.performance.desc': '하나의 노드 바이너리가 세 워크체인을 함께 제공합니다. 공개 API, 검증, liteserver 역할, 워크체인 디스패치가 모두 같은 진실의 루트에 연결됩니다.',
    'features.trilemma.title': '하나의 표준 CLI',
    'features.trilemma.desc': 'tosctl은 네트워크 운영과 지갑의 진입점입니다. 노드 운영, 지갑 흐름, 워크체인별 도구를 여러 sidecar 대신 하나의 경로로 묶습니다.',
    'features.instant.title': '통합 JSON-RPC',
    'features.instant.desc': '노드는 TOS 네이티브 tos_*, wc=1의 표준 eth_*, wc=2의 uno_*를 함께 제공합니다. 하나의 RPC 면에서 세 실행 도메인을 다룹니다.',
    'features.pruning.title': 'Cell 네이티브 상태',
    'features.pruning.desc': 'TVM cells, EVM 계정 상태, Uno 실드 상태가 모두 TOS cells에 커밋됩니다. 실행 모델이 달라도 저장 계층은 통일됩니다.',
    'features.spv.title': '결정론적 실행',
    'features.spv.desc': '합의 핵심 경로는 벽시계, OS 난수, 비결정적 map 순회를 피합니다. 이 저장소는 결정론을 SDK 관행이 아니라 프로토콜 불변조건으로 다룹니다.',
    'features.fairlaunch.title': '공유 masterchain 합의',
    'features.fairlaunch.desc': 'wc=0, wc=1, wc=2는 하나의 masterchain 루트 합의 아래 있는 1급 워크체인입니다. 사용자는 거래마다 실행 도메인을 고르고, 검증자는 워크체인별로 참여합니다.',
    'features.deflationary.title': '네이티브 ↔ EVM 가치 이동',
    'features.deflationary.desc': '네이티브 레이어와 wc=1 사이의 가치 이동은 TOS 메시지 모델을 사용합니다. Uno는 의도적으로 격리되며 shield도 unshield도 bridge도 없습니다.',
    'features.takovm.title': 'Catchain 기반',
    'features.takovm.desc': '블록 생성은 Catchain에 기반하며, 더 명확한 진행 증명과 검증자 동작을 위해 점차 Simplex 지향 설계로 수렴하고 있습니다.',
    'features.community.title': '이더리움 툴체인 호환',
    'features.community.desc': 'MetaMask, ethers.js, web3.py, Foundry, Hardhat, Remix가 wc=1에 어댑터 없이 연결됩니다. 기존 Solidity 코드베이스도 그대로 배포할 수 있습니다.',
    'features.zkprivacy.title': 'PQ 네이티브 프라이버시 자세',
    'features.zkprivacy.desc': 'Uno는 첫날부터 해시 기반 STARK 증명과 하이브리드 PQ 노트 암호화를 사용해, 페어링 기반 프라이버시 시스템이 안고 있는 마이그레이션 부채를 줄입니다.',
    'features.cryptography.title': 'Plonky3 + ML-KEM',
    'features.cryptography.desc': 'Uno는 Goldilocks 위의 Plonky3 STARK, Poseidon2, ML-KEM-768 하이브리드 노트 암호화를 결합합니다. 지갑이 로컬에서 증명하고 검증자는 결정론적으로 검증합니다.',
    'features.parallel.title': '검증자 + liteserver 운영',
    'features.parallel.desc': '저장소에는 validator-engine, liteserver, proxy-liteserver, 관련 운영 도구가 이미 포함되어 있습니다. TOS는 단순한 컨트랙트 배포 UX가 아니라 실제 노드 스택을 중심으로 설계되었습니다.',
    'features.security.title': '소스 우선 기술 문서',
    'features.security.desc': 'README, BUILD.md, EVM 토폴로지 문서, Uno 설계 문서, Catchain 논문, 변경 로그는 무엇이 실제로 구현되었고 무엇이 진행 중인지 가장 빨리 파악하는 경로입니다.',
    'features.encrypted.title': 'ADNL / DHT / RLDP / QUIC',
    'features.encrypted.desc': 'TOS는 자체 네트워크 스택을 갖고 있습니다. ADNL ID, DHT 발견, RLDP 전송, QUIC 상호운용 테스트, 검증자 overlay가 노드 간 경로를 뒷받침합니다.',
    'features.communication.title': 'Sites, DNS, Connect',
    'features.communication.desc': '체인 실행 외에도 코드베이스에는 TOS Connect 지갑 연결 흐름, TOS DNS 이름 해석, TOS Sites 스타일 분산 서빙 프리미티브가 이미 포함되어 있습니다.',
    'features.coreTitle': '하나의 마스터체인, 세 가지 실행 도메인',
    'features.coreSubtitle': '서로 다른 워크로드에는 서로 다른 절충이 필요합니다. TOS는 네이티브 샤드 TVM, 이더리움 호환 EVM, UNO 프라이버시를 병렬로 운영하며 모든 것을 하나의 VM에 억지로 넣지 않습니다.',
    'performance.title': '코드베이스 기준 기술 스냅샷',
    'performance.subtitle': '현재 저장소에서 특히 눈에 띄는 몇 가지 사실입니다.',
    'stats.workchains.label': '워크체인',
    'stats.workchains.desc': 'wc=0 TVM, wc=1 EVM, wc=2 Uno',
    'stats.node.label': '노드 바이너리',
    'stats.node.desc': 'validator-engine가 전체 스택을 제공',
    'stats.cli.label': '표준 CLI',
    'stats.cli.desc': 'tosctl이 운영과 지갑 흐름 담당',
    'stats.cadence.label': '글로벌 주기',
    'stats.cadence.desc': 'TOS 전체가 약 1초 블록 리듬 공유',
    'stats.rpc.label': 'JSON-RPC',
    'stats.rpc.desc': 'wc=1에서 표준 이더리움 메서드 제공',
    'stats.bridges.label': 'Uno 브리지',
    'stats.bridges.desc': 'shield, unshield, bridge 없음',
    'stats.state.label': '상태 모델',
    'stats.state.desc': 'TVM, EVM, Uno가 cells 공유',
    'stats.network.label': '네트워크 스택',
    'stats.network.desc': 'ADNL, DHT, RLDP, QUIC',
    'docs.title': '기술 진입점',
    'docs.desc': '먼저 저장소 안의 1차 문서부터 보세요.',
    'docs.smartContracts': '리포지토리 개요',
    'docs.aiMining': 'EVM 워크체인',
    'docs.exploreAll': 'Uno 워크체인',
    'whitepaper.title': '백서와 기술 참고자료',
    'whitepaper.desc': '메인 저장소에서 동기화한 최신 TOS 백서, 합의 문서, 저수준 기술 참고자료를 읽을 수 있습니다.',
    ...
    'faq.title': '자주 묻는 질문',
    'faq.q1': 'TOS 네트워크란 무엇인가요?',
    'faq.a1': 'TOS는 멀티체인 Layer-1입니다. 하나의 masterchain 루트 합의 아래에서 wc=0의 비동기 네이티브 TVM, wc=1의 이더리움 호환 EVM, wc=2의 PQ 네이티브 Uno 프라이버시를 제공합니다. 하나의 validator-engine, 하나의 tosctl 경로, 하나의 cell-native 상태 모델이 전체를 묶습니다.',
    'faq.q2': 'TOS 네트워크의 장점은 무엇인가요?',
    'faq.a2.h1': '네이티브 레이어 (wc=0)',
    'faq.a2.p1': '비동기 샤딩 TVM 실행은 고처리량 컨트랙트, actor 스타일 앱, 프로토콜 프리미티브를 위한 메시지 기반 베이스 레이어를 제공합니다.',
    'faq.a2.h2': 'EVM 워크체인 (wc=1)',
    'faq.a2.p2': 'wc=1은 이더리움 의미론과 표준 JSON-RPC를 유지하므로 Solidity, MetaMask, ethers.js, Foundry, Hardhat, Remix를 그대로 사용할 수 있습니다.',
    'faq.a2.h3': 'Uno 프라이버시 (wc=2)',
    'faq.a2.p3': 'Uno는 Plonky3 STARK, Poseidon2, ECDH + ML-KEM-768 하이브리드 암호화를 기반으로 한 브리지 없는 실드 note-pool 워크체인입니다.',
    'faq.a2.h4': '하나의 노드, 하나의 CLI, 하나의 RPC 면',
    'faq.a2.p4': 'validator-engine가 공개 API와 검증 경로를 제공하고, tosctl이 전체 스택의 표준 운영 및 지갑 진입점 역할을 합니다.',
    'faq.a2.h5': 'Cell 네이티브와 결정론',
    'faq.a2.p5': 'TVM, EVM, Uno는 같은 cell 기반 상태 모델에 커밋하며, 합의 핵심 실행에서는 벽시계, 시스템 난수, 비결정적 순회를 피합니다.',
    'faq.q3': 'EVM 워크체인의 호환성은 어느 정도인가요?',
    'faq.a3': 'wc=1은 EVM 모양의 래퍼가 아니라 이더리움처럼 느껴지도록 설계되었습니다. 노드가 표준 eth_* JSON-RPC를 직접 제공하고, MetaMask, ethers.js, web3.py, Foundry, Hardhat, Remix를 1급 툴체인으로 둡니다.',
    'faq.q4': 'Uno는 브리지 기반 프라이버시와 무엇이 다른가요?',
    'faq.a4': 'Uno는 공개 자산 위에 붙는 믹서가 아닙니다. 공급이 제네시스에서부터 실드된 별도의 네이티브 프라이버시 워크체인이며, shield, unshield, 다른 워크체인과의 bridge를 영구적인 구조 규칙으로 금지합니다.',
    'faq.q5': '운영자는 실제로 무엇을 실행하나요?',
    'faq.a5': '코드베이스는 validator-engine와 주변 노드 스택을 중심으로 구성되어 있고, tosctl이 표준 CLI입니다. BUILD.md에는 liteserver, proxy-liteserver, Rust 측 도구, Uno를 포함한 전체 빌드 전제조건도 정리되어 있습니다.',
    'faq.q6': '체인 코어 밖에는 어떤 제품 프리미티브가 이미 있나요?',
    'faq.a6': '저장소에는 TOS Connect 지갑 연결 흐름, TOS DNS 이름 해석, TOS Sites 스타일 분산 서빙, 그리고 노드 및 제품 연결을 지탱하는 ADNL / DHT / RLDP / QUIC 스택이 이미 들어 있습니다.',
    'faq.q7': 'TOS가 단일 VM 체인과 다른 점은 무엇인가요?',
    'faq.a7': 'TOS는 모든 워크로드를 하나의 실행 모델에 억지로 넣지 않습니다. 네이티브 TVM, EVM, Uno 프라이버시는 각자의 불변조건이 다른 부분에서 분리되지만, 같은 masterchain 루트 합의와 같은 운영 경로, 같은 상태 기반을 공유합니다.',
    'faq.bottomText': '오류나 누락을 발견했다면, 저장소를 1차 정보로 확인하세요.',
    'footer.getStarted': '먼저 보기',
    'footer.getTOS': '개요 읽기',
    'footer.startMining': '소스에서 빌드',
    'footer.buildOnTOS': 'Uno 워크체인',
    'footer.learnMore': '기술 자료',
    'footer.resources': '리포지토리',
    'footer.devTools': 'EVM 워크체인',
...
Object.entries(homepageOverrides).forEach(([lang, overrides]) => {
  if (translations[lang]) {
    Object.assign(translations[lang], overrides);
  }
});
