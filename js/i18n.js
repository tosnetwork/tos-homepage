...
const homepageOverrides = {
  en: {
    ...
    'nav.whitepaper': 'Whitepaper',
    'hero.title': 'Build in Public.<br><span class="highlight">Move Value in Private.</span>',
    'hero.getTOS': 'Read Overview',
    'hero.startMining': 'EVM Workchain',
    'features.subtitle': 'The native rail is built async and shard-ready for speed at scale. The EVM rail stays synchronous so Ethereum apps feel familiar. Uno handles value that should stay private.',
